...
public class CreateAccessModeOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link CreateAccessModeOperationSpec}.
     *
     ...
     * @param body                 The request contains the access mode information.
     */
    @ApiStatus.Internal
    public CreateAccessModeOperationSpec(String listenerKey, AccessModeType body) {
