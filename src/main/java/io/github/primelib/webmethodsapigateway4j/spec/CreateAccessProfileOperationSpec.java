...
public class CreateAccessProfileOperationSpec {
     ...
     * @param body                 This parameter describes the request payload of a accessProfile that is to be created in API Gateway.
     */
    @ApiStatus.Internal
    public CreateAccessProfileOperationSpec(AccessProfile body) {
        this.body = body;
