 ...
 * <p>
 * Specification for the PatchApplication operation.
 */
@Getter
@Setter
@EqualsAndHashCode
...
public class PatchApplicationOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link PatchApplicationOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public PatchApplicationOperationSpec(Consumer<PatchApplicationOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public PatchApplicationOperationSpec(String applicationId, Application body) {
