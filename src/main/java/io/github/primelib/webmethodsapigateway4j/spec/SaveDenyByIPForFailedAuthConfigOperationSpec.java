...
public class SaveDenyByIPForFailedAuthConfigOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link SaveDenyByIPForFailedAuthConfigOperationSpec}.
     *
     ...
     */
    @ApiStatus.Internal
    public SaveDenyByIPForFailedAuthConfigOperationSpec(DenyByIPForFailedAuthConfig body) {
        this.body = body;
