...
public class RefreshCredentialsOperationSpec {
     ...
     * @param body                 This parameter describes the request payload for the strategy to be refreshed in API Gateway.
     */
    @ApiStatus.Internal
    public RefreshCredentialsOperationSpec(String strategyId, StrategyRequest body) {
