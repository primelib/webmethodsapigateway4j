...
/**
 * GetPortAccessModeSpec
 * <p>
 * Specification for the GetPortAccessMode operation.
 */
@Getter
@Setter
@EqualsAndHashCode
...
public class GetPortAccessModeOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link GetPortAccessModeOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public GetPortAccessModeOperationSpec(Consumer<GetPortAccessModeOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public GetPortAccessModeOperationSpec(String listenerKey) {
