...
public class SaveElasticsearchAsDestinationOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link SaveElasticsearchAsDestinationOperationSpec}.
     *
     ...
     */
    @ApiStatus.Internal
    public SaveElasticsearchAsDestinationOperationSpec(ElasticsearchDestination body) {
        this.body = body;
