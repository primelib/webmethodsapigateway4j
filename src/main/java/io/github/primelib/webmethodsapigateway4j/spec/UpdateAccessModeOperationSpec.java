...
public class UpdateAccessModeOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link UpdateAccessModeOperationSpec}.
     *
     ...
     * @param body                 The request contains the updated services access mode information.
     */
    @ApiStatus.Internal
    public UpdateAccessModeOperationSpec(String listenerKey, AccessModeServices body) {
