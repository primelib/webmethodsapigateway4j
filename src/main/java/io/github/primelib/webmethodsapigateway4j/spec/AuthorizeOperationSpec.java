 ...
 * AuthorizeSpec
 * <p>
 * Specification for the Authorize operation.
 */
@Getter
@Setter
@EqualsAndHashCode
...
public class AuthorizeOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link AuthorizeOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public AuthorizeOperationSpec(Consumer<AuthorizeOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public AuthorizeOperationSpec(User body) {
        this.body = body;
