...
/**
 * DeactivatePackageByPackageIdSpec
 * <p>
 * Specification for the DeactivatePackageByPackageId operation.
 */
@Getter
@Setter
@EqualsAndHashCode
...
public class DeactivatePackageByPackageIdOperationSpec {
     ...
     */
    @ApiStatus.Internal
    public DeactivatePackageByPackageIdOperationSpec(String packageId) {
