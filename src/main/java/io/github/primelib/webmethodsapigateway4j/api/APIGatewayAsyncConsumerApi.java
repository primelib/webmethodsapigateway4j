...
public class APIGatewayAsyncConsumerApi {
    private final APIGatewayAsyncApi api;

    public APIGatewayAsyncConsumerApi(APIGatewayAsyncApi api) {
        this.api = api;
    }
     ...
     * </ul>
     */
    public CompletableFuture<ModelAPIResponse> activateAPI(Consumer<ActivateAPIOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<String> activateDC(Consumer<ActivateDCOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Policy> activateGlobalPolicyByPolicyID(Consumer<ActivateGlobalPolicyByPolicyIDOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Object> activateNodes(Consumer<ActivateNodesOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<PackageResponseContainer> activatePackageByPackageId(Consumer<ActivatePackageByPackageIdOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Rule> activateRule(Consumer<ActivateRuleOperationSpec> spec) {
     ...
     */
    public CompletableFuture<HealthCheckAdminResult> adminGet() {
        return api.adminGet();
    }
     ...
     * </ul>
     */
    public CompletableFuture<Map<String, Object>> aggregations(Consumer<AggregationsOperationSpec> spec) {
     ...
     * Perform health check for all components of API Gateway.
     */
    public CompletableFuture<HealthCheckAllResult> allGet() {
        return api.allGet();
    }
     ...
     * </ul>
     */
    public CompletableFuture<Void> apiTransactionsArchiveBasedOnDuration(Consumer<ApiTransactionsArchiveBasedOnDurationOperationSpec> spec) {
        ApiTransactionsArchiveBasedOnDurationOperationSpec r = new ApiTransactionsArchiveBasedOnDurationOperationSpec(spec);
        return api.apiTransactionsArchiveBasedOnDuration(r.from(), r.until(), r.eventType(), r.olderThan());
    }
     ...
     * </ul>
     */
    public CompletableFuture<RemotePortConfig> appendRingConfiguration(Consumer<AppendRingConfigurationOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<ApprovalPutResponse> approveorrejectApprovalRequest(Consumer<ApproveorrejectApprovalRequestOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Void> archiveTraceInfo(Consumer<ArchiveTraceInfoOperationSpec> spec) {
        ArchiveTraceInfoOperationSpec r = new ArchiveTraceInfoOperationSpec(spec);
        return api.archiveTraceInfo(r.body());
    }
     ...
     * </ul>
     */
    public CompletableFuture<User> authorize(Consumer<AuthorizeOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<User> authorizeUser(Consumer<AuthorizeUserOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<ChangeOwnerResponse> changeOwner(Consumer<ChangeOwnerOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<ChangeOwnerResponse> changeTeam(Consumer<ChangeTeamOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Policy> checkConflictForGlobalPolicy(Consumer<CheckConflictForGlobalPolicyOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Object> configureNodes(Consumer<ConfigureNodesOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Map<String, Integer>> countByType(Consumer<CountByTypeOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<APIResponseCreate> createAPI(Consumer<CreateAPIOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<PortalGateway> createAPIPortalConfiguration(Consumer<CreateAPIPortalConfigurationOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<AccessModeType> createAccessMode(Consumer<CreateAccessModeOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<AccessProfile> createAccessProfile(Consumer<CreateAccessProfileOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Alias> createAlias(Consumer<CreateAliasOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Application> createApplication(Consumer<CreateApplicationOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<ApprovalConfiguration> createApprovalConfiguration(Consumer<CreateApprovalConfigurationOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<AssertionConfiguration> createAssertion(Consumer<CreateAssertionOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<IPAccessModeType> createIPAccessMode(Consumer<CreateIPAccessModeOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<JMSConnectionAlias> createJMSConnection(Consumer<CreateJMSConnectionOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<JNDIProviderAlias> createJNDI(Consumer<CreateJNDIOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<KeyStore> createKeystore(Consumer<CreateKeystoreOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<GatewayScope> createOAuthScope(Consumer<CreateOAuthScopeOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Void> createOutboundProxy(Consumer<CreateOutboundProxyOperationSpec> spec) {
        CreateOutboundProxyOperationSpec r = new CreateOutboundProxyOperationSpec(spec);
        return api.createOutboundProxy(r.body());
    }
     ...
     * </ul>
     */
    public CompletableFuture<PackageResponseContainer> createPackage(Consumer<CreatePackageOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<PlanResponseContainer> createPlan(Consumer<CreatePlanOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<PolicyAction> createPolicyAction(Consumer<CreatePolicyActionOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Port> createPort(Consumer<CreatePortOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Promotion> createPromotion(Consumer<CreatePromotionOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Rule> createRule(Consumer<CreateRuleOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Stage> createStage(Consumer<CreateStageOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<OneOfStrategyModel> createStrategy(Consumer<CreateStrategyOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Application> createSubscription(Consumer<CreateSubscriptionOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<TrustStore> createTruststore(Consumer<CreateTruststoreOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<URLAliasSettings> createURLALias(Consumer<CreateURLALiasOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<ModelAPIResponse> createVersion(Consumer<CreateVersionOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Webhook> createWebhook(Consumer<CreateWebhookOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<WebserviceEndpointAlias> createWebserviceEndpoint(Consumer<CreateWebserviceEndpointOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<ModelAPIResponse> deactivateAPI(Consumer<DeactivateAPIOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Policy> deactivateGlobalPolicyByPolicyID(Consumer<DeactivateGlobalPolicyByPolicyIDOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<PackageResponseContainer> deactivatePackageByPackageId(Consumer<DeactivatePackageByPackageIdOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Rule> deactivateRule(Consumer<DeactivateRuleOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<APIResponseDelete> deleteAPI(Consumer<DeleteAPIOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Void> deleteAPIPortalConfiguration(Consumer<DeleteAPIPortalConfigurationOperationSpec> spec) {
        DeleteAPIPortalConfigurationOperationSpec r = new DeleteAPIPortalConfigurationOperationSpec(spec);
        return api.deleteAPIPortalConfiguration(r.portalGatewayId());
    }
     ...
     * </ul>
     */
    public CompletableFuture<List<APIResponseDelete>> deleteAPIs(Consumer<DeleteAPIsOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Void> deleteAccessProfile(Consumer<DeleteAccessProfileOperationSpec> spec) {
        DeleteAccessProfileOperationSpec r = new DeleteAccessProfileOperationSpec(spec);
        return api.deleteAccessProfile(r.accessProfileId());
    }
     ...
     * </ul>
     */
    public CompletableFuture<Void> deleteAlias(Consumer<DeleteAliasOperationSpec> spec) {
        DeleteAliasOperationSpec r = new DeleteAliasOperationSpec(spec);
        return api.deleteAlias(r.aliasId());
    }
     ...
     * </ul>
     */
    public CompletableFuture<Void> deleteApplic(Consumer<DeleteApplicOperationSpec> spec) {
        DeleteApplicOperationSpec r = new DeleteApplicOperationSpec(spec);
        return api.deleteApplic(r.applicationId());
    }
     ...
     * </ul>
     */
    public CompletableFuture<Void> deleteApplications(Consumer<DeleteApplicationsOperationSpec> spec) {
        DeleteApplicationsOperationSpec r = new DeleteApplicationsOperationSpec(spec);
        return api.deleteApplications(r.ids());
    }
     ...
     * </ul>
     */
    public CompletableFuture<Void> deleteApprovalConfiguration(Consumer<DeleteApprovalConfigurationOperationSpec> spec) {
        DeleteApprovalConfigurationOperationSpec r = new DeleteApprovalConfigurationOperationSpec(spec);
        return api.deleteApprovalConfiguration(r.id());
    }
     ...
     * </ul>
     */
    public CompletableFuture<Void> deleteApprovalRequest(Consumer<DeleteApprovalRequestOperationSpec> spec) {
        DeleteApprovalRequestOperationSpec r = new DeleteApprovalRequestOperationSpec(spec);
        return api.deleteApprovalRequest(r.approvalId());
    }
     ...
     * </ul>
     */
    public CompletableFuture<Void> deleteAssertion(Consumer<DeleteAssertionOperationSpec> spec) {
        DeleteAssertionOperationSpec r = new DeleteAssertionOperationSpec(spec);
        return api.deleteAssertion(r.assertionId());
    }
     ...
     * </ul>
     */
    public CompletableFuture<Void> deleteCacheDetailsByapiNameAndVersion(Consumer<DeleteCacheDetailsByapiNameAndVersionOperationSpec> spec) {
        DeleteCacheDetailsByapiNameAndVersionOperationSpec r = new DeleteCacheDetailsByapiNameAndVersionOperationSpec(spec);
        return api.deleteCacheDetailsByapiNameAndVersion(r.apiName(), r.apiVersion());
    }
     ...
     * </ul>
     */
    public CompletableFuture<Void> deleteCacheDetailsbyAPIId(Consumer<DeleteCacheDetailsbyAPIIdOperationSpec> spec) {
        DeleteCacheDetailsbyAPIIdOperationSpec r = new DeleteCacheDetailsbyAPIIdOperationSpec(spec);
        return api.deleteCacheDetailsbyAPIId(r.apiId());
    }
     ...
     * </ul>
     */
    public CompletableFuture<Void> deleteDeniedIPs(Consumer<DeleteDeniedIPsOperationSpec> spec) {
        DeleteDeniedIPsOperationSpec r = new DeleteDeniedIPsOperationSpec(spec);
        return api.deleteDeniedIPs(r.IP());
    }
     ...
     * </ul>
     */
    public CompletableFuture<Void> deleteDocument(Consumer<DeleteDocumentOperationSpec> spec) {
        DeleteDocumentOperationSpec r = new DeleteDocumentOperationSpec(spec);
        return api.deleteDocument(r.documentId());
    }
     ...
     * </ul>
     */
    public CompletableFuture<Void> deleteGroup(Consumer<DeleteGroupOperationSpec> spec) {
        DeleteGroupOperationSpec r = new DeleteGroupOperationSpec(spec);
        return api.deleteGroup(r.groupId());
    }
     ...
     * </ul>
     */
    public CompletableFuture<Void> deleteJMSConnection(Consumer<DeleteJMSConnectionOperationSpec> spec) {
        DeleteJMSConnectionOperationSpec r = new DeleteJMSConnectionOperationSpec(spec);
        return api.deleteJMSConnection(r.jmsConnId());
    }
     ...
     * </ul>
     */
    public CompletableFuture<Void> deleteJNDI(Consumer<DeleteJNDIOperationSpec> spec) {
        DeleteJNDIOperationSpec r = new DeleteJNDIOperationSpec(spec);
        return api.deleteJNDI(r.jndiId());
    }
     ...
     * </ul>
     */
    public CompletableFuture<List<KeyStore>> deleteKeystore(Consumer<DeleteKeystoreOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Void> deleteOAuthScope(Consumer<DeleteOAuthScopeOperationSpec> spec) {
        DeleteOAuthScopeOperationSpec r = new DeleteOAuthScopeOperationSpec(spec);
        return api.deleteOAuthScope(r.oauthScopeId());
    }
     ...
     * </ul>
     */
    public CompletableFuture<Void> deleteOutboundProxy(Consumer<DeleteOutboundProxyOperationSpec> spec) {
        DeleteOutboundProxyOperationSpec r = new DeleteOutboundProxyOperationSpec(spec);
        return api.deleteOutboundProxy(r.outboundproxyAlias());
    }
     ...
     * </ul>
     */
    public CompletableFuture<Void> deletePackageById(Consumer<DeletePackageByIdOperationSpec> spec) {
        DeletePackageByIdOperationSpec r = new DeletePackageByIdOperationSpec(spec);
        return api.deletePackageById(r.packageId());
    }
     ...
     * </ul>
     */
    public CompletableFuture<Void> deletePlanById(Consumer<DeletePlanByIdOperationSpec> spec) {
        DeletePlanByIdOperationSpec r = new DeletePlanByIdOperationSpec(spec);
        return api.deletePlanById(r.planId());
    }
     ...
     * </ul>
     */
    public CompletableFuture<Void> deletePolicyAction(Consumer<DeletePolicyActionOperationSpec> spec) {
        DeletePolicyActionOperationSpec r = new DeletePolicyActionOperationSpec(spec);
        return api.deletePolicyAction(r.policyActionId());
    }
     ...
     * </ul>
     */
    public CompletableFuture<Void> deletePolicyByID(Consumer<DeletePolicyByIDOperationSpec> spec) {
        DeletePolicyByIDOperationSpec r = new DeletePolicyByIDOperationSpec(spec);
        return api.deletePolicyByID(r.policyId());
    }
     ...
     * </ul>
     */
    public CompletableFuture<Void> deletePort(Consumer<DeletePortOperationSpec> spec) {
        DeletePortOperationSpec r = new DeletePortOperationSpec(spec);
        return api.deletePort(r.pkg(), r.listenerKey());
    }
     ...
     * </ul>
     */
    public CompletableFuture<Void> deletePromotion(Consumer<DeletePromotionOperationSpec> spec) {
        DeletePromotionOperationSpec r = new DeletePromotionOperationSpec(spec);
        return api.deletePromotion(r.promotionId());
    }
     ...
     * </ul>
     */
    public CompletableFuture<Void> deleteRollback(Consumer<DeleteRollbackOperationSpec> spec) {
        DeleteRollbackOperationSpec r = new DeleteRollbackOperationSpec(spec);
        return api.deleteRollback(r.rollbackId());
    }
     ...
     * </ul>
     */
    public CompletableFuture<Void> deleteRule(Consumer<DeleteRuleOperationSpec> spec) {
        DeleteRuleOperationSpec r = new DeleteRuleOperationSpec(spec);
        return api.deleteRule(r.ruleId());
    }
     ...
     * </ul>
     */
    public CompletableFuture<Void> deleteStage(Consumer<DeleteStageOperationSpec> spec) {
        DeleteStageOperationSpec r = new DeleteStageOperationSpec(spec);
        return api.deleteStage(r.stageId());
    }
     ...
     * </ul>
     */
    public CompletableFuture<Void> deleteStrategy(Consumer<DeleteStrategyOperationSpec> spec) {
        DeleteStrategyOperationSpec r = new DeleteStrategyOperationSpec(spec);
        return api.deleteStrategy(r.ids());
    }
     ...
     * </ul>
     */
    public CompletableFuture<Void> deleteSubscriptionBySubscriptionID(Consumer<DeleteSubscriptionBySubscriptionIDOperationSpec> spec) {
        DeleteSubscriptionBySubscriptionIDOperationSpec r = new DeleteSubscriptionBySubscriptionIDOperationSpec(spec);
        return api.deleteSubscriptionBySubscriptionID(r.applicationId());
    }
     ...
     * </ul>
     */
    public CompletableFuture<Void> deleteTruststore(Consumer<DeleteTruststoreOperationSpec> spec) {
        DeleteTruststoreOperationSpec r = new DeleteTruststoreOperationSpec(spec);
        return api.deleteTruststore(r.trustStoreName());
    }
     ...
     * </ul>
     */
    public CompletableFuture<Void> deleteURLAlias(Consumer<DeleteURLAliasOperationSpec> spec) {
        DeleteURLAliasOperationSpec r = new DeleteURLAliasOperationSpec(spec);
        return api.deleteURLAlias(r.alias());
    }
    ...
    public CompletableFuture<Void> deleteUser(Consumer<DeleteUserOperationSpec> spec) {
        ...
        return api.deleteUser(r.userId());
    }
     ...
     * </ul>
     */
    public CompletableFuture<Void> deleteWebhook(Consumer<DeleteWebhookOperationSpec> spec) {
        DeleteWebhookOperationSpec r = new DeleteWebhookOperationSpec(spec);
        return api.deleteWebhook(r.id());
    }
     ...
     * </ul>
     */
    public CompletableFuture<Void> deleteWebserviceEndpoint(Consumer<DeleteWebserviceEndpointOperationSpec> spec) {
        DeleteWebserviceEndpointOperationSpec r = new DeleteWebserviceEndpointOperationSpec(spec);
        return api.deleteWebserviceEndpoint(r.webserviceEndpointId());
    }
     ...
     * </ul>
     */
    public CompletableFuture<Void> disableJMSConnection(Consumer<DisableJMSConnectionOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Void> disableJMSTrigger(Consumer<DisableJMSTriggerOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<ModelAPIResponse> disableMockAPI(Consumer<DisableMockAPIOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Void> disableOutboundProxy(Consumer<DisableOutboundProxyOperationSpec> spec) {
        DisableOutboundProxyOperationSpec r = new DisableOutboundProxyOperationSpec(spec);
        return api.disableOutboundProxy(r.outboundproxyAlias());
    }
     ...
     * </ul>
     */
    public CompletableFuture<MessageWithPortReference> disablePort(Consumer<DisablePortOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Policy> disableThreatProtectionRuleByPolicyID(Consumer<DisableThreatProtectionRuleByPolicyIDOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<GatewayAPI> disableTracing(Consumer<DisableTracingOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Rollback> doRollback(Consumer<DoRollbackOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Void> downloadAPITransaction(Consumer<DownloadAPITransactionOperationSpec> spec) {
        DownloadAPITransactionOperationSpec r = new DownloadAPITransactionOperationSpec(spec);
        return api.downloadAPITransaction(r.startDate(), r.endDate(), r.eventType(), r.duration());
    }
     ...
     */
    public CompletableFuture<Void> downloadLogs() {
        return api.downloadLogs();
    }
     ...
     * </ul>
     */
    public CompletableFuture<APIResponseGetAPI> downloadProviderSpecification(Consumer<DownloadProviderSpecificationOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Void> enableJMSConnection(Consumer<EnableJMSConnectionOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Void> enableJMSTrigger(Consumer<EnableJMSTriggerOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<ModelAPIResponse> enableMockAPI(Consumer<EnableMockAPIOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Void> enableOutboundProxy(Consumer<EnableOutboundProxyOperationSpec> spec) {
        EnableOutboundProxyOperationSpec r = new EnableOutboundProxyOperationSpec(spec);
        return api.enableOutboundProxy(r.outboundproxyAlias());
    }
     ...
     * </ul>
     */
    public CompletableFuture<PortReference> enablePort(Consumer<EnablePortOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Policy> enableThreatProtectionRuleByPolicyID(Consumer<EnableThreatProtectionRuleByPolicyIDOperationSpec> spec) {
     ...
     */
    public CompletableFuture<HealthCheckEngineResult> engineGet() {
     ...
     * </ul>
     */
    public CompletableFuture<ServiceOutput> exchangeIDToken(Consumer<ExchangeIDTokenOperationSpec> spec) {
     ...
     */
    public CompletableFuture<HealthCheckExternalResult> externalServicesGet() {
     ...
     */
    public CompletableFuture<Void> fetchJNDITemplates() {
     ...
     * </ul>
     */
    public CompletableFuture<ModelAPIResponse> gatewayEndpoints(Consumer<GatewayEndpointsOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<APIResponseGetAPI> getAPI(Consumer<GetAPIOperationSpec> spec) {
     ...
     */
    public CompletableFuture<CallbackProcessorSettings> getAPICallbackProcessorSettings() {
     ...
     */
    public CompletableFuture<Destination> getAPIPortalAsDestination() {
     ...
     * </ul>
     */
    public CompletableFuture<PortalGateway> getAPIPortalConfiguration(Consumer<GetAPIPortalConfigurationOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<PortalGatewayCommunitiesData> getAPIPortalMetadata(Consumer<GetAPIPortalMetadataOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<APIResponsesModel> getAPIs(Consumer<GetAPIsOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<PackageAPIsResponseContainer> getAPIsForPackageById(Consumer<GetAPIsForPackageByIdOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<AccessProfile> getAccessProfile(Consumer<GetAccessProfileOperationSpec> spec) {
     ...
     */
    public CompletableFuture<AccessProfile> getAccessProfiles() {
     ...
     * </ul>
     */
    public CompletableFuture<Void> getAccessTokenEndpoints(Consumer<GetAccessTokenEndpointsOperationSpec> spec) {
     ...
     */
    public CompletableFuture<AccountLockSettings> getAccountLockSettings() {
     ...
     * </ul>
     */
    public CompletableFuture<Alias> getAlias(Consumer<GetAliasOperationSpec> spec) {
     ...
     */
    public CompletableFuture<PortalGateway> getAllAPIPortalConfiguration() {
     ...
     */
    public CompletableFuture<List<Alias>> getAllAlias() {
     ...
     */
    public CompletableFuture<AssertionConfiguration> getAllAssertions() {
     ...
     */
    public CompletableFuture<Void> getAllJMSConnections() {
     ...
     */
    public CompletableFuture<Void> getAllJMSTriggers() {
     ...
     */
    public CompletableFuture<PackageGetAllResponseContainer> getAllPackages() {
     ...
     */
    public CompletableFuture<PlanGetAllResponse> getAllPlans() {
     ...
     * </ul>
     */
    public CompletableFuture<List<PolicyAction>> getAllPolicyActions(Consumer<GetAllPolicyActionsOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<List<Rule>> getAllRule(Consumer<GetAllRuleOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<List<Usage>> getAllSubscriptionUsage(Consumer<GetAllSubscriptionUsageOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<List<Application>> getAllSubscriptions(Consumer<GetAllSubscriptionsOperationSpec> spec) {
     ...
     */
    public CompletableFuture<List<Webhook>> getAllWebhooks() {
     ...
     */
    public CompletableFuture<Void> getAllWebserviceEndpoints() {
        return api.getAllWebserviceEndpoints();
    }

    /**
     */
    public CompletableFuture<AnalyticsDataStoreDestination> getAnalyticsDataStoreAsDestination() {
     ...
     * </ul>
     */
    public CompletableFuture<List<Application>> getApiApplications(Consumer<GetApiApplicationsOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<List<APIResponseGetAPIs>> getApplicableAPIsForGlobalPolicyByID(Consumer<GetApplicableAPIsForGlobalPolicyByIDOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Application> getApplication(Consumer<GetApplicationOperationSpec> spec) {
     ...
     */
    public CompletableFuture<Application> getApplications() {
     ...
     * </ul>
     */
    public CompletableFuture<ApprovalRequest> getApproval(Consumer<GetApprovalOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<ApprovalConfiguration> getApprovalConfiguration(Consumer<GetApprovalConfigurationOperationSpec> spec) {
     ...
     */
    public CompletableFuture<ApprovalConfiguration> getApprovalConfigurations() {
     ...
     */
    public CompletableFuture<List<ApprovalResponsePayload>> getApprovals() {
     ...
     * </ul>
     */
    public CompletableFuture<AssertionConfiguration> getAssertion(Consumer<GetAssertionOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<APIResponseGetGlobalPolicies> getAssociatedGlobalPolicies(Consumer<GetAssociatedGlobalPoliciesOperationSpec> spec) {
     ...
     */
    public CompletableFuture<AuditLogDestination> getAuditLogAsDestination() {
        return api.getAuditLogAsDestination();
    }

    /**
     */
    public CompletableFuture<GatewayCacheConfig> getCacheConfig() {
     ...
     * </ul>
     */
    public CompletableFuture<Void> getCacheDetailsByapiId(Consumer<GetCacheDetailsByapiIdOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Void> getCacheDetailsByapiNameAndVersion(Consumer<GetCacheDetailsByapiNameAndVersionOperationSpec> spec) {
     ...
     */
    public CompletableFuture<CSCommunicationDestination> getCentraSiteCommunicationAsDestination() {
     ...
     */
    public CompletableFuture<CSSNMPDestination> getCentraSiteSNMPAsDestination() {
     ...
     */
    public CompletableFuture<ClusterInfo> getClusterSetting() {
     ...
     */
    public CompletableFuture<Object> getCustomContentTypes() {
     ...
     */
    public CompletableFuture<Destination> getDatabaseAsDestination() {
     ...
     */
    public CompletableFuture<RemotePortConfig> getDataspaceConfiguration() {
     ...
     */
    public CompletableFuture<List<String>> getDeniedIPs() {
     ...
     */
    public CompletableFuture<DenyByIPForFailedAuthConfig> getDenyByIPForFailedAuthConfig() {
     ...
     */
    public CompletableFuture<Destination> getDigitalEventsAsDestination() {
     ...
     * </ul>
     */
    public CompletableFuture<Document> getDocument(Consumer<GetDocumentOperationSpec> spec) {
     ...
     */
    public CompletableFuture<ElasticsearchDestination> getElasticsearchAsDestination() {
     ...
     */
    public CompletableFuture<EmailDestination> getEmailAsDestination() {
     ...
     */
    public CompletableFuture<ErrorProcessing> getErrorProcessingDetails() {
     ...
     */
    public CompletableFuture<Destination> getGatewayAsDestination() {
     ...
     * </ul>
     */
    public CompletableFuture<IPAccessMode> getIPAccessMode(Consumer<GetIPAccessModeOperationSpec> spec) {
     ...
     */
    public CompletableFuture<List<String>> getInstalledLanguages() {
     ...
     * </ul>
     */
    public CompletableFuture<ServiceRegistryPublishGetResponse> getIntegrationServerPublishInfo(Consumer<GetIntegrationServerPublishInfoOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<JMSConnectionAlias> getJMSConnection(Consumer<GetJMSConnectionOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<JMSTrigger> getJMSTrigger(Consumer<GetJMSTriggerOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<JWT> getJsonWebToken(Consumer<GetJsonWebTokenOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<JWTServiceOutput> getJsonWebTokenNew(Consumer<GetJsonWebTokenNewOperationSpec> spec) {
     ...
     */
    public CompletableFuture<KerberosSettings> getKerberosSetting() {
     ...
     */
    public CompletableFuture<KeystoreTruststore> getKeyStoreTrustore() {
     ...
     * </ul>
     */
    public CompletableFuture<List<KeyStore>> getKeystore(Consumer<GetKeystoreOperationSpec> spec) {
     ...
     */
    public CompletableFuture<List<KeyStore>> getKeystores() {
     ...
     */
    public CompletableFuture<InputLdapConfiguration> getLdapConfig() {
     ...
     */
    public CompletableFuture<LicenseDetail> getLicenseDetails() {
     ...
     */
    public CompletableFuture<ListenerConfig> getListenerConfiguration() {
     ...
     */
    public CompletableFuture<LoadBalancer> getLoadBalancers() {
     ...
     */
    public CompletableFuture<LockedAccounts> getLockedAccounts() {
     ...
     */
    public CompletableFuture<LogConfiguration> getLogConfig() {
     ...
     */
    public CompletableFuture<Void> getMappings() {
     ...
     */
    public CompletableFuture<MasterPasswordProperties> getMasterPasswordProperties() {
     ...
     * </ul>
     */
    public CompletableFuture<Void> getMigrationStatus(Consumer<GetMigrationStatusOperationSpec> spec) {
     ...
     */
    public CompletableFuture<MobileApplicationConfiguration> getMobileApplicationConfigurations() {
     ...
     * </ul>
     */
    public CompletableFuture<GatewayScope> getOAuthScope(Consumer<GetOAuthScopeOperationSpec> spec) {
     ...
     */
    public CompletableFuture<GatewayScope> getOAuthScopes() {
     ...
     */
    public CompletableFuture<OutboundProxyGetResponse> getOutboundProxies() {
     ...
     * </ul>
     */
    public CompletableFuture<PackageGetResponseContainer> getPackageById(Consumer<GetPackageByIdOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<List<ModelPackage>> getPackagesForAPI(Consumer<GetPackagesForAPIOperationSpec> spec) {
     ...
     */
    public CompletableFuture<PasswordExpirySettings> getPasswordExpirySettings() {
     ...
     */
    public CompletableFuture<PasswordRestrictions> getPasswordRestrictions() {
     ...
     * </ul>
     */
    public CompletableFuture<PlanGetResponse> getPlanById(Consumer<GetPlanByIdOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<PackagePlansResponseContainer> getPlansForPackageById(Consumer<GetPlansForPackageByIdOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<List<Policy>> getPolicies(Consumer<GetPoliciesOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<PolicyActionWrapper> getPolicyAction(Consumer<GetPolicyActionOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Policy> getPolicyById(Consumer<GetPolicyByIdOperationSpec> spec) {
     ...
     */
    public CompletableFuture<List<PolicyEnforcementStage>> getPolicyStages() {
     ...
     * </ul>
     */
    public CompletableFuture<Port> getPort(Consumer<GetPortOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Port> getPortAccessMode(Consumer<GetPortAccessModeOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Listeners> getPorts(Consumer<GetPortsOperationSpec> spec) {
     ...
     */
    public CompletableFuture<MessageWithPortReference> getPrimaryPort() {
     ...
     * </ul>
     */
    public CompletableFuture<Promotion> getPromotion(Consumer<GetPromotionOperationSpec> spec) {
     ...
     */
    public CompletableFuture<List<Promotion>> getPromotions() {
     ...
     */
    public CompletableFuture<ProxyBypass> getProxyBypass() {
     ...
     * </ul>
     */
    public CompletableFuture<Set<Object>> getPublishedPackages(Consumer<GetPublishedPackagesOperationSpec> spec) {
     ...
     */
    public CompletableFuture<QuiesceMode> getQuiesceMode() {
     ...
     * </ul>
     */
    public CompletableFuture<Void> getRegisteredApis(Consumer<GetRegisteredApisOperationSpec> spec) {
     ...
     */
    public CompletableFuture<RemotePortConfig> getRingConfiguration() {
     ...
     * </ul>
     */
    public CompletableFuture<Rollback> getRollback(Consumer<GetRollbackOperationSpec> spec) {
     ...
     */
    public CompletableFuture<List<Rollback>> getRollbacks() {
     ...
     * </ul>
     */
    public CompletableFuture<Rule> getRule(Consumer<GetRuleOperationSpec> spec) {
     ...
     */
    public CompletableFuture<SNMPDestination> getSNMPAsDestination() {
     ...
     */
    public CompletableFuture<SSOConfiguration> getSSOConfiguration() {
     ...
     * </ul>
     */
    public CompletableFuture<List<ScopeResourceIndex>> getScopeByScopeName(Consumer<GetScopeByScopeNameOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<List<ScopeResourceIndex>> getScopes(Consumer<GetScopesOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<ServiceRegistryPublishGetResponse> getServiceRegistryPublishInfo(Consumer<GetServiceRegistryPublishInfoOperationSpec> spec) {
     ...
     */
    public CompletableFuture<ExtendedSettingsOutput> getSettings() {
     ...
     * </ul>
     */
    public CompletableFuture<List<Multipart>> getSource(Consumer<GetSourceOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Stage> getStage(Consumer<GetStageOperationSpec> spec) {
     ...
     */
    public CompletableFuture<List<Stage>> getStages() {
     ...
     */
    public CompletableFuture<OneOfStrategyModel> getStrategies() {
     ...
     * </ul>
     */
    public CompletableFuture<OneOfStrategyModel> getStrategy(Consumer<GetStrategyOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Application> getSubscriptionBySubscriptionID(Consumer<GetSubscriptionBySubscriptionIDOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Map<String, List<TraceLog>>> getTracer(Consumer<GetTracerOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<TransactionEvent> getTransactions(Consumer<GetTransactionsOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<TransactionResponse> getTransactionsCount(Consumer<GetTransactionsCountOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<List<TrustStore>> getTruststore(Consumer<GetTruststoreOperationSpec> spec) {
     ...
     */
    public CompletableFuture<List<TrustStore>> getTruststores() {
     ...
     * </ul>
     */
    public CompletableFuture<URLAliasesGetResponse> getURLALias(Consumer<GetURLALiasOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Usage> getUsageBySubscriptionID(Consumer<GetUsageBySubscriptionIDOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<APIResponseGetAPIs> getVersions(Consumer<GetVersionsOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Webhook> getWebhook(Consumer<GetWebhookOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<WebserviceEndpointAlias> getWebserviceEndpoint(Consumer<GetWebserviceEndpointOperationSpec> spec) {
     ...
     */
    public CompletableFuture<WhiteListedIPs> getWhiteListedIPs() {
     ...
     * </ul>
     */
    public CompletableFuture<Void> importExportAPIGatewayAssets(Consumer<ImportExportAPIGatewayAssetsOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<ImportTraceInfoResponse> importTraceInfo(Consumer<ImportTraceInfoOperationSpec> spec) {
     ...
     */
    public CompletableFuture<Object> jWKSUri() {
        return api.jWKSUri();
    }
     ...
     * </ul>
     */
    public CompletableFuture<Void> listAllArchives(Consumer<ListAllArchivesOperationSpec> spec) {
     ...
     */
    public CompletableFuture<Void> listAllJNDI() {
     ...
     * </ul>
     */
    public CompletableFuture<Void> listAllPendingJobs(Consumer<ListAllPendingJobsOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<JNDIProviderAlias> listJNDI(Consumer<ListJNDIOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Void> migration(Consumer<MigrationOperationSpec> spec) {
        MigrationOperationSpec r = new MigrationOperationSpec(spec);
        return api.migration(r.body());
    }
     ...
     * </ul>
     */
    public CompletableFuture<Policy> moveDownThreatProtectionRuleByPolicyID(Consumer<MoveDownThreatProtectionRuleByPolicyIDOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Policy> moveUpThreatProtectionRuleByPolicyID(Consumer<MoveUpThreatProtectionRuleByPolicyIDOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<ModelAPIResponse> notifyAPIImplementation(Consumer<NotifyAPIImplementationOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Application> patchApplication(Consumer<PatchApplicationOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<DocumentResponse> patchDocument(Consumer<PatchDocumentOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Policy> policiesPost(Consumer<PoliciesPostOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<List<PolicyActionTemplate>> policyActionTemplatesGet(Consumer<PolicyActionTemplatesGetOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<PolicyActionTemplate> policyActionTemplatesPolicyActionTemplateIdGet(Consumer<PolicyActionTemplatesPolicyActionTemplateIdGetOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<APIResponseCreate> publishAPI(Consumer<PublishAPIOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<PackageResponseContainer> publishPackageByPackageId(Consumer<PublishPackageByPackageIdOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<ServiceRegistryPublishPutResponse> publishToIntegrationServer(Consumer<PublishToIntegrationServerOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<ServiceRegistryPublishPutResponse> publishToServiceRegistry(Consumer<PublishToServiceRegistryOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Void> purgeAPITransactions(Consumer<PurgeAPITransactionsOperationSpec> spec) {
        PurgeAPITransactionsOperationSpec r = new PurgeAPITransactionsOperationSpec(spec);
        return api.purgeAPITransactions(r.from(), r.until(), r.eventType(), r.action(), r.olderThan());
    }
     ...
     * </ul>
     */
    public CompletableFuture<QuiesceMode> quiescemode(Consumer<QuiescemodeOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<OneOfStrategyModel> refreshCredentials(Consumer<RefreshCredentialsOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Void> regenerateAccessTokens(Consumer<RegenerateAccessTokensOperationSpec> spec) {
        RegenerateAccessTokensOperationSpec r = new RegenerateAccessTokensOperationSpec(spec);
        return api.regenerateAccessTokens(r.applicationId(), r.body());
    }
     ...
     * </ul>
     */
    public CompletableFuture<Void> registerApis(Consumer<RegisterApisOperationSpec> spec) {
        RegisterApisOperationSpec r = new RegisterApisOperationSpec(spec);
        return api.registerApis(r.applicationId(), r.body());
    }
     ...
     */
    public CompletableFuture<MasterPasswordResetResponse> resetMasterPassword() {
     ...
     * </ul>
     */
    public CompletableFuture<Void> restoreData(Consumer<RestoreDataOperationSpec> spec) {
        RestoreDataOperationSpec r = new RestoreDataOperationSpec(spec);
        return api.restoreData(r.fileName());
    }
     ...
     * </ul>
     */
    public CompletableFuture<CallbackProcessorSettings> saveAPICallbackProcessorSettings(Consumer<SaveAPICallbackProcessorSettingsOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Destination> saveAPIPortalAsDestination(Consumer<SaveAPIPortalAsDestinationOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<AccountLockSettings> saveAccountLockSettings(Consumer<SaveAccountLockSettingsOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<AnalyticsDataStoreDestination> saveAnalyticsDataStoreAsDestination(Consumer<SaveAnalyticsDataStoreAsDestinationOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<AuditLogDestination> saveAuditLogAsDestination(Consumer<SaveAuditLogAsDestinationOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<CSCommunicationDestination> saveCentraSiteCommunicationAsDestination(Consumer<SaveCentraSiteCommunicationAsDestinationOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<CSSNMPDestination> saveCentraSiteSNMPAsDestination(Consumer<SaveCentraSiteSNMPAsDestinationOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Object> saveCustomContentTypes(Consumer<SaveCustomContentTypesOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Destination> saveDatabaseAsDestination(Consumer<SaveDatabaseAsDestinationOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<DenyByIPForFailedAuthConfig> saveDenyByIPForFailedAuthConfig(Consumer<SaveDenyByIPForFailedAuthConfigOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Destination> saveDigitalEventsAsDestination(Consumer<SaveDigitalEventsAsDestinationOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<ElasticsearchDestination> saveElasticsearchAsDestination(Consumer<SaveElasticsearchAsDestinationOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<EmailDestination> saveEmailAsDestination(Consumer<SaveEmailAsDestinationOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<ErrorProcessing> saveErrorProcessingDetails(Consumer<SaveErrorProcessingDetailsOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Destination> saveGatewayAsDestination(Consumer<SaveGatewayAsDestinationOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<KeystoreTruststore> saveKeystoreTruststore(Consumer<SaveKeystoreTruststoreOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<InputLdapConfiguration> saveLdapConfig(Consumer<SaveLdapConfigOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<LoadBalancer> saveLoadBalancers(Consumer<SaveLoadBalancersOperationSpec> spec) {
     ...
     */
    public CompletableFuture<LogConfiguration> saveLogConfig() {
     ...
     * </ul>
     */
    public CompletableFuture<MobileApplicationConfiguration> saveMobileApplicationConfigurations(Consumer<SaveMobileApplicationConfigurationsOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<PasswordExpirySettings> savePasswordExpirySettings(Consumer<SavePasswordExpirySettingsOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<PasswordRestrictions> savePasswordRestrictions(Consumer<SavePasswordRestrictionsOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Void> saveProxyBypass(Consumer<SaveProxyBypassOperationSpec> spec) {
        SaveProxyBypassOperationSpec r = new SaveProxyBypassOperationSpec(spec);
        return api.saveProxyBypass(r.body());
    }
     ...
     * </ul>
     */
    public CompletableFuture<SNMPDestination> saveSNMPAsDestination(Consumer<SaveSNMPAsDestinationOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<SSOConfiguration> saveSSOConfig(Consumer<SaveSSOConfigOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<ExtendedSettingsOutput> saveSettings(Consumer<SaveSettingsOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<WhiteListedIPs> saveWhitelistedIPs(Consumer<SaveWhitelistedIPsOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Map<String, Object>> searchByType(Consumer<SearchByTypeOperationSpec> spec) {
    ...
    /**
     */
    public CompletableFuture<ServerInfo> serverInformation() {
     ...
     * </ul>
     */
    public CompletableFuture<PortReference> setPrimaryPort(Consumer<SetPrimaryPortOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Void> shutdown(Consumer<ShutdownOperationSpec> spec) {
        ShutdownOperationSpec r = new ShutdownOperationSpec(spec);
        return api.shutdown(r.body());
    }
     ...
     * </ul>
     */
    public CompletableFuture<DocumentResponse> storeDocument(Consumer<StoreDocumentOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Void> testJNDI(Consumer<TestJNDIOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<GatewayAPI> tracingEnable(Consumer<TracingEnableOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Void> trackJobStatus(Consumer<TrackJobStatusOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<LockedAccounts> unLockUserAccounts(Consumer<UnLockUserAccountsOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<PackageResponseContainer> unPublishPackageByPackageId(Consumer<UnPublishPackageByPackageIdOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<APIResponseCreate> unpublishAPI(Consumer<UnpublishAPIOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<ServiceRegistryUnpublishPutResponse> unpublishFromServiceRegistry(Consumer<UnpublishFromServiceRegistryOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<APIResponseCreate> updateAPI(Consumer<UpdateAPIOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<PortalGateway> updateAPIPortalConfiguration(Consumer<UpdateAPIPortalConfigurationOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<AccessModeServices> updateAccessMode(Consumer<UpdateAccessModeOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<AccessProfile> updateAccessProfile(Consumer<UpdateAccessProfileOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Alias> updateAlias(Consumer<UpdateAliasOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Void> updateApiKeysExpiry(Consumer<UpdateApiKeysExpiryOperationSpec> spec) {
        UpdateApiKeysExpiryOperationSpec r = new UpdateApiKeysExpiryOperationSpec(spec);
        return api.updateApiKeysExpiry(r.body());
    }
     ...
     * </ul>
     */
    public CompletableFuture<Application> updateApplication(Consumer<UpdateApplicationOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<ApprovalConfiguration> updateApprovalConfiguration(Consumer<UpdateApprovalConfigurationOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<AssertionConfiguration> updateAssertion(Consumer<UpdateAssertionOperationSpec> spec) {
    ...
    /**
     */
    public CompletableFuture<GatewayCacheConfig> updateCacheConfig() {
     ...
     * </ul>
     */
    public CompletableFuture<ClusterInfo> updateCluster(Consumer<UpdateClusterOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<DocumentResponse> updateDocumentContent(Consumer<UpdateDocumentContentOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<MasterPasswordExpiryIntervalResponse> updateExpiryInterval(Consumer<UpdateExpiryIntervalOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Group> updateGroup(Consumer<UpdateGroupOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<JMSConnectionAlias> updateJMSConnection(Consumer<UpdateJMSConnectionOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<JMSTrigger> updateJMSTrigger(Consumer<UpdateJMSTriggerOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<JNDIProviderAlias> updateJNDI(Consumer<UpdateJNDIOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Void> updateKerberos(Consumer<UpdateKerberosOperationSpec> spec) {
        UpdateKerberosOperationSpec r = new UpdateKerberosOperationSpec(spec);
        return api.updateKerberos(r.body());
    }
     ...
     * </ul>
     */
    public CompletableFuture<KeyStore> updateKeystoreAliases(Consumer<UpdateKeystoreAliasesOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Void> updateLicenseDetails(Consumer<UpdateLicenseDetailsOperationSpec> spec) {
        UpdateLicenseDetailsOperationSpec r = new UpdateLicenseDetailsOperationSpec(spec);
        return api.updateLicenseDetails(r.body());
    }
     ...
     * </ul>
     */
    public CompletableFuture<ListenerConfig> updateListenerConfiguration(Consumer<UpdateListenerConfigurationOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<MasterPasswordUpdateResponse> updateMasterPassword(Consumer<UpdateMasterPasswordOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<GatewayScope> updateOAuthScope(Consumer<UpdateOAuthScopeOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Void> updateOutboundProxy(Consumer<UpdateOutboundProxyOperationSpec> spec) {
        UpdateOutboundProxyOperationSpec r = new UpdateOutboundProxyOperationSpec(spec);
        return api.updateOutboundProxy(r.body());
    }
     ...
     * </ul>
     */
    public CompletableFuture<PackageResponseContainer> updatePackageByPackageId(Consumer<UpdatePackageByPackageIdOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<PlanGetResponse> updatePlanByPlanId(Consumer<UpdatePlanByPlanIdOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<PolicyActionWrapper> updatePolicyAction(Consumer<UpdatePolicyActionOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Policy> updatePolicyByID(Consumer<UpdatePolicyByIDOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Port> updatePort(Consumer<UpdatePortOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Void> updateProxyBypass(Consumer<UpdateProxyBypassOperationSpec> spec) {
        UpdateProxyBypassOperationSpec r = new UpdateProxyBypassOperationSpec(spec);
        return api.updateProxyBypass(r.body());
    }
     ...
     * </ul>
     */
    public CompletableFuture<Void> updateRegisteredApis(Consumer<UpdateRegisteredApisOperationSpec> spec) {
        UpdateRegisteredApisOperationSpec r = new UpdateRegisteredApisOperationSpec(spec);
        return api.updateRegisteredApis(r.applicationId(), r.body());
    }
     ...
     * </ul>
     */
    public CompletableFuture<RemotePortConfig> updateRingConfiguration(Consumer<UpdateRingConfigurationOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Rule> updateRule(Consumer<UpdateRuleOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Stage> updateStage(Consumer<UpdateStageOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<OneOfStrategyModel> updateStrategy(Consumer<UpdateStrategyOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Application> updateSubscription(Consumer<UpdateSubscriptionOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<TrustStore> updateTruststore(Consumer<UpdateTruststoreOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<URLAliasSettings> updateURLALias(Consumer<UpdateURLALiasOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<User> updateUser(Consumer<UpdateUserOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<Webhook> updateWebhook(Consumer<UpdateWebhookOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<WebserviceEndpointAlias> updateWebserviceEndpoint(Consumer<UpdateWebserviceEndpointOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<IPAccessModeHostsList> updatedIPAccessMode(Consumer<UpdatedIPAccessModeOperationSpec> spec) {
