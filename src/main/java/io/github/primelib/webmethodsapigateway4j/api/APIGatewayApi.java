...
public interface APIGatewayApi {
    ...
    List<Usage> getAllSubscriptionUsage(@Param("name") @Nullable String name, @Param("_package") @Nullable String _package, @Param("plan") @Nullable String plan, @Param("from") @Nullable Integer from, @Param("size") @Nullable Integer size, @Param("count") @Nullable String count);
    ...
    JWT getJsonWebToken(@Param("appId") @Nullable String appId);
