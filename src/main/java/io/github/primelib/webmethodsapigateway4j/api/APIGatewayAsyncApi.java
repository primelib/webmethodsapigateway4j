...
public interface APIGatewayAsyncApi {
    ...
    CompletableFuture<ModelAPIResponse> activateAPI(@Param("apiId") @NotNull String apiId);
    ...
    CompletableFuture<String> activateDC(@NotNull String body);
    ...
    CompletableFuture<Policy> activateGlobalPolicyByPolicyID(@Param("policyId") @NotNull String policyId);
    ...
    CompletableFuture<Object> activateNodes(@NotNull Object body);
    ...
    CompletableFuture<PackageResponseContainer> activatePackageByPackageId(@Param("packageId") @NotNull String packageId);
    ...
    CompletableFuture<Rule> activateRule(@Param("ruleId") @NotNull String ruleId);
    ...
    CompletableFuture<HealthCheckAdminResult> adminGet();
    ...
    CompletableFuture<Map<String, Object>> aggregations(@NotNull SearchContext body);
    ...
    CompletableFuture<HealthCheckAllResult> allGet();
    ...
    CompletableFuture<Void> apiTransactionsArchiveBasedOnDuration(@Param("from") @NotNull String from, @Param("until") @NotNull String until, @Param("eventType") @NotNull String eventType, @Param("olderThan") @Nullable String olderThan);
    ...
    CompletableFuture<RemotePortConfig> appendRingConfiguration(@NotNull RemotePortConfig body);
    ...
    CompletableFuture<ApprovalPutResponse> approveorrejectApprovalRequest(@Param("approvalId") @NotNull String approvalId, @Param("action") @NotNull String action, @Nullable ApprovalPutRequest body);
    ...
    CompletableFuture<Void> archiveTraceInfo(@NotNull ArchiveTraceInfoRequest body);
    ...
    CompletableFuture<User> authorize(@NotNull User body);
    ...
    CompletableFuture<User> authorizeUser(@NotNull User body);
    ...
    CompletableFuture<ChangeOwnerResponse> changeOwner(@NotNull ChangeOwnerRequest body);
    ...
    CompletableFuture<ChangeOwnerResponse> changeTeam(@NotNull ChangeOwnerRequest body);
    ...
    CompletableFuture<Policy> checkConflictForGlobalPolicy(@Param("policyId") @NotNull String policyId, @Param("active") @Nullable String active);
    ...
    CompletableFuture<Object> configureNodes(@NotNull Object body);
    ...
    CompletableFuture<Map<String, Integer>> countByType(@NotNull SearchContext body);
    ...
    CompletableFuture<APIResponseCreate> createAPI(@NotNull CreateAPIRequest body);
    ...
    CompletableFuture<PortalGateway> createAPIPortalConfiguration(@NotNull PortalGateway body);
    ...
    CompletableFuture<AccessModeType> createAccessMode(@Param("listenerKey") @NotNull String listenerKey, @NotNull AccessModeType body);
    ...
    CompletableFuture<AccessProfile> createAccessProfile(@NotNull AccessProfile body);
    ...
    CompletableFuture<Alias> createAlias(@NotNull Alias body);
    ...
    CompletableFuture<Application> createApplication(@NotNull Application body);
    ...
    CompletableFuture<ApprovalConfiguration> createApprovalConfiguration(@NotNull ApprovalConfiguration body);
    ...
    CompletableFuture<AssertionConfiguration> createAssertion(@NotNull AssertionConfiguration body);
    ...
    CompletableFuture<Group> createGroup(@NotNull Group body);
    ...
    CompletableFuture<IPAccessModeType> createIPAccessMode(@Param("listenerKey") @NotNull String listenerKey, @NotNull IPAccessModeType body);
    ...
    CompletableFuture<JMSConnectionAlias> createJMSConnection(@NotNull JMSConnectionAlias body);
    ...
    CompletableFuture<JNDIProviderAlias> createJNDI(@NotNull JNDIProviderAlias body);
    ...
    CompletableFuture<GatewayScope> createOAuthScope(@NotNull GatewayScope body);
    ...
    CompletableFuture<Void> createOutboundProxy(@NotNull OutboundProxySettings body);
    ...
    CompletableFuture<PackageResponseContainer> createPackage(@Nullable ModelPackage body);
    ...
    CompletableFuture<PlanResponseContainer> createPlan(@Nullable Plan body);
    ...
    CompletableFuture<PolicyAction> createPolicyAction(@NotNull PolicyAction body);
    ...
    CompletableFuture<Port> createPort(@Nullable Port body);
    ...
    CompletableFuture<Promotion> createPromotion(@NotNull Promotion body, @Param("fixingMissingVersions") @Nullable String fixingMissingVersions, @Param("overwrite") @Nullable Boolean overwrite, @Param("overwriteAlias") @Nullable Boolean overwriteAlias);
    ...
    CompletableFuture<Rule> createRule(@NotNull Rule body);
    ...
    CompletableFuture<Stage> createStage(@NotNull Stage body);
    ...
    CompletableFuture<OneOfStrategyModel> createStrategy(@NotNull StrategyRequest body);
    ...
    CompletableFuture<Application> createSubscription(@Nullable SubscriptionRequest body);
    ...
    CompletableFuture<URLAliasSettings> createURLALias(@NotNull URLAliasSettings body);
    ...
    CompletableFuture<User> createUser(@NotNull User body);
    ...
    CompletableFuture<ModelAPIResponse> createVersion(@Param("apiId") @NotNull String apiId, @NotNull InputVersion body);
    ...
    CompletableFuture<Webhook> createWebhook(@NotNull Webhook body);
    ...
    CompletableFuture<WebserviceEndpointAlias> createWebserviceEndpoint(@NotNull WebserviceEndpointAlias body);
    ...
    CompletableFuture<ModelAPIResponse> deactivateAPI(@Param("apiId") @NotNull String apiId);
    ...
    CompletableFuture<Policy> deactivateGlobalPolicyByPolicyID(@Param("policyId") @NotNull String policyId);
    ...
    CompletableFuture<PackageResponseContainer> deactivatePackageByPackageId(@Param("packageId") @NotNull String packageId);
    ...
    CompletableFuture<Rule> deactivateRule(@Param("ruleId") @NotNull String ruleId);
    ...
    CompletableFuture<APIResponseDelete> deleteAPI(@Param("apiId") @NotNull String apiId, @Param("forceDelete") @Nullable Boolean forceDelete);
    ...
    CompletableFuture<Void> deleteAPIPortalConfiguration(@Param("portalGatewayId") @NotNull String portalGatewayId);
    ...
    CompletableFuture<List<APIResponseDelete>> deleteAPIs(@Param("apiIds") @NotNull String apiIds, @Param("forceDelete") @Nullable Boolean forceDelete);
    ...
    CompletableFuture<Void> deleteAccessProfile(@Param("accessProfileId") @NotNull String accessProfileId);
    ...
    CompletableFuture<Void> deleteAlias(@Param("aliasId") @NotNull String aliasId);
    ...
    CompletableFuture<Void> deleteApplic(@Param("applicationId") @NotNull String applicationId);
    ...
    CompletableFuture<Void> deleteApplications(@Param("ids") @Nullable String ids);
    ...
    CompletableFuture<Void> deleteApprovalConfiguration(@Param("id") @NotNull String id);
    ...
    CompletableFuture<Void> deleteApprovalRequest(@Param("approvalId") @NotNull String approvalId);
    ...
    CompletableFuture<Void> deleteAssertion(@Param("assertionId") @NotNull String assertionId);
    ...
    CompletableFuture<Void> deleteCacheDetailsByapiNameAndVersion(@Param("apiName") @NotNull String apiName, @Param("apiVersion") @NotNull String apiVersion);
    ...
    CompletableFuture<Void> deleteCacheDetailsbyAPIId(@Param("apiId") @NotNull String apiId);
    ...
    CompletableFuture<Void> deleteDeniedIPs(@Param("IP") @NotNull String IP);
    ...
    CompletableFuture<Void> deleteDocument(@Param("documentId") @NotNull String documentId);
    ...
    CompletableFuture<Void> deleteGroup(@Param("groupId") @NotNull String groupId);
    ...
    CompletableFuture<Void> deleteJMSConnection(@Param("jmsConnId") @NotNull String jmsConnId);
    ...
    CompletableFuture<Void> deleteJNDI(@Param("jndiId") @NotNull String jndiId);
    ...
    CompletableFuture<List<KeyStore>> deleteKeystore(@Param("keyStoreName") @NotNull String keyStoreName);
    ...
    CompletableFuture<Void> deleteOAuthScope(@Param("oauthScopeId") @NotNull String oauthScopeId);
    ...
    CompletableFuture<Void> deleteOutboundProxy(@Param("outboundproxyAlias") @NotNull String outboundproxyAlias);
    ...
    CompletableFuture<Void> deletePackageById(@Param("packageId") @NotNull String packageId);
    ...
    CompletableFuture<Void> deletePlanById(@Param("planId") @NotNull String planId);
    ...
    CompletableFuture<Void> deletePolicyAction(@Param("policyActionId") @NotNull String policyActionId);
    ...
    CompletableFuture<Void> deletePolicyByID(@Param("policyId") @NotNull String policyId);
    ...
    CompletableFuture<Void> deletePort(@Param("pkg") @Nullable String pkg, @Param("listenerKey") @Nullable String listenerKey);
    ...
    CompletableFuture<Void> deletePromotion(@Param("promotionId") @NotNull String promotionId);
    ...
    CompletableFuture<Void> deleteRollback(@Param("rollbackId") @NotNull String rollbackId);
    ...
    CompletableFuture<Void> deleteRule(@Param("ruleId") @NotNull String ruleId);
    ...
    CompletableFuture<Void> deleteStage(@Param("stageId") @NotNull String stageId);
    ...
    CompletableFuture<Void> deleteStrategy(@Param("ids") @Nullable String ids);
    ...
    CompletableFuture<Void> deleteSubscriptionBySubscriptionID(@Param("applicationId") @NotNull String applicationId);
    ...
    CompletableFuture<Void> deleteTruststore(@Param("trustStoreName") @NotNull String trustStoreName);
    ...
    CompletableFuture<Void> deleteURLAlias(@Param("alias") @NotNull String alias);
    ...
    CompletableFuture<Void> deleteUser(@Param("userId") @NotNull String userId);
    ...
    CompletableFuture<Void> deleteWebhook(@Param("id") @NotNull String id);
    ...
    CompletableFuture<Void> deleteWebserviceEndpoint(@Param("webserviceEndpointId") @NotNull String webserviceEndpointId);
    ...
    CompletableFuture<Void> disableJMSConnection(@Param("jmsConnId") @NotNull String jmsConnId);
    ...
    CompletableFuture<Void> disableJMSTrigger(@Param("jmsTriggerId") @NotNull String jmsTriggerId);
    ...
    CompletableFuture<ModelAPIResponse> disableMockAPI(@Param("apiId") @NotNull String apiId);
    ...
    CompletableFuture<Void> disableOutboundProxy(@Param("outboundproxyAlias") @NotNull String outboundproxyAlias);
    ...
    CompletableFuture<MessageWithPortReference> disablePort(@NotNull PortReference body);
    ...
    CompletableFuture<Policy> disableThreatProtectionRuleByPolicyID(@Param("policyId") @NotNull String policyId);
    ...
    CompletableFuture<GatewayAPI> disableTracing(@Param("apiId") @NotNull String apiId);
    ...
    CompletableFuture<Rollback> doRollback(@Param("rollbackId") @NotNull String rollbackId);
    ...
    CompletableFuture<Void> downloadAPITransaction(@Param("startDate") @NotNull String startDate, @Param("endDate") @NotNull String endDate, @Param("eventType") @NotNull String eventType, @Param("duration") @Nullable String duration);
    ...
    CompletableFuture<Void> downloadLogs();
    ...
    CompletableFuture<APIResponseGetAPI> downloadProviderSpecification(@Param("apiId") @NotNull String apiId, @Param("format") @NotNull String format);
    ...
    CompletableFuture<Void> enableJMSConnection(@Param("jmsConnId") @NotNull String jmsConnId);
    ...
    CompletableFuture<Void> enableJMSTrigger(@Param("jmsTriggerId") @NotNull String jmsTriggerId);
    ...
    CompletableFuture<ModelAPIResponse> enableMockAPI(@Param("apiId") @NotNull String apiId, @Param("retainDefaultMockResponses") @Nullable Boolean retainDefaultMockResponses);
    ...
    CompletableFuture<Void> enableOutboundProxy(@Param("outboundproxyAlias") @NotNull String outboundproxyAlias);
    ...
    CompletableFuture<PortReference> enablePort(@Nullable PortReference body);
    ...
    CompletableFuture<Policy> enableThreatProtectionRuleByPolicyID(@Param("policyId") @NotNull String policyId);
    ...
    CompletableFuture<HealthCheckEngineResult> engineGet();
    ...
    CompletableFuture<ServiceOutput> exchangeIDToken(@NotNull ServiceInput body);
    ...
    CompletableFuture<HealthCheckExternalResult> externalServicesGet();
    ...
    CompletableFuture<Void> fetchJNDITemplates();
    ...
    CompletableFuture<ModelAPIResponse> gatewayEndpoints(@Param("apiId") @NotNull String apiId, @NotNull InputGatewayEndpoints body);
    ...
    CompletableFuture<APIResponseGetAPI> getAPI(@Param("apiId") @NotNull String apiId, @Param("format") @Nullable String format, @Param("url") @Nullable String url);
    ...
    CompletableFuture<CallbackProcessorSettings> getAPICallbackProcessorSettings();
    ...
    CompletableFuture<Destination> getAPIPortalAsDestination();
    ...
    CompletableFuture<PortalGateway> getAPIPortalConfiguration(@Param("portalGatewayId") @NotNull String portalGatewayId);
    ...
    CompletableFuture<PortalGatewayCommunitiesData> getAPIPortalMetadata(@Param("portalGatewayId") @NotNull String portalGatewayId, @Param("apiId") @NotNull String apiId);
    ...
    CompletableFuture<APIResponsesModel> getAPIs(@Param("apiIds") @Nullable String apiIds, @Param("from") @Nullable Integer from, @Param("size") @Nullable Integer size);
    ...
    CompletableFuture<PackageAPIsResponseContainer> getAPIsForPackageById(@Param("packageId") @NotNull String packageId);
    ...
    CompletableFuture<AccessProfile> getAccessProfile(@Param("accessProfileId") @NotNull String accessProfileId);
    ...
    CompletableFuture<AccessProfile> getAccessProfiles();
    ...
    CompletableFuture<Void> getAccessTokenEndpoints(@Param("applicationId") @NotNull String applicationId);
    ...
    CompletableFuture<AccountLockSettings> getAccountLockSettings();
    ...
    CompletableFuture<Alias> getAlias(@Param("aliasId") @NotNull String aliasId);
    ...
    CompletableFuture<PortalGateway> getAllAPIPortalConfiguration();
    ...
    CompletableFuture<List<Alias>> getAllAlias();
    ...
    CompletableFuture<AssertionConfiguration> getAllAssertions();
    ...
    CompletableFuture<Void> getAllJMSConnections();
    ...
    CompletableFuture<Void> getAllJMSTriggers();
    ...
    CompletableFuture<PackageGetAllResponseContainer> getAllPackages();
    ...
    CompletableFuture<PlanGetAllResponse> getAllPlans();
    ...
    CompletableFuture<List<PolicyAction>> getAllPolicyActions(@Param("policyActionIds") @Nullable String policyActionIds);
    ...
    CompletableFuture<List<Rule>> getAllRule(@Param("ruleType") @Nullable String ruleType, @Param("active") @Nullable String active);
    ...
    CompletableFuture<List<Usage>> getAllSubscriptionUsage(@Param("name") @Nullable String name, @Param("_package") @Nullable String _package, @Param("plan") @Nullable String plan, @Param("from") @Nullable Integer from, @Param("size") @Nullable Integer size, @Param("count") @Nullable String count);
    ...
    CompletableFuture<List<Application>> getAllSubscriptions(@Param("packageId") @Nullable String packageId, @Param("planId") @Nullable String planId);
    ...
    CompletableFuture<List<Webhook>> getAllWebhooks();
    ...
    CompletableFuture<Void> getAllWebserviceEndpoints();
    ...
    CompletableFuture<AnalyticsDataStoreDestination> getAnalyticsDataStoreAsDestination();
    ...
    CompletableFuture<List<Application>> getApiApplications(@Param("apiId") @NotNull String apiId);
    ...
    CompletableFuture<List<APIResponseGetAPIs>> getApplicableAPIsForGlobalPolicyByID(@Param("policyId") @NotNull String policyId, @Param("active") @Nullable String active);
    ...
    CompletableFuture<Application> getApplication(@Param("applicationId") @NotNull String applicationId);
    ...
    CompletableFuture<Application> getApplications();
    ...
    CompletableFuture<ApprovalRequest> getApproval(@Param("approvalId") @NotNull String approvalId);
    ...
    CompletableFuture<ApprovalConfiguration> getApprovalConfiguration(@Param("id") @NotNull String id);
    ...
    CompletableFuture<ApprovalConfiguration> getApprovalConfigurations();
    ...
    CompletableFuture<List<ApprovalResponsePayload>> getApprovals();
    ...
    CompletableFuture<AssertionConfiguration> getAssertion(@Param("assertionId") @NotNull String assertionId);
    ...
    CompletableFuture<APIResponseGetGlobalPolicies> getAssociatedGlobalPolicies(@Param("apiId") @NotNull String apiId);
    ...
    CompletableFuture<AuditLogDestination> getAuditLogAsDestination();
    ...
    CompletableFuture<GatewayCacheConfig> getCacheConfig();
    ...
    CompletableFuture<Void> getCacheDetailsByapiId(@Param("apiId") @NotNull String apiId);
    ...
    CompletableFuture<Void> getCacheDetailsByapiNameAndVersion(@Param("apiName") @NotNull String apiName, @Param("apiVersion") @NotNull String apiVersion);
    ...
    CompletableFuture<CSCommunicationDestination> getCentraSiteCommunicationAsDestination();
    ...
    CompletableFuture<CSSNMPDestination> getCentraSiteSNMPAsDestination();
    ...
    CompletableFuture<ClusterInfo> getClusterSetting();
    ...
    CompletableFuture<Object> getCustomContentTypes();
    ...
    CompletableFuture<Destination> getDatabaseAsDestination();
    ...
    CompletableFuture<RemotePortConfig> getDataspaceConfiguration();
    ...
    CompletableFuture<List<String>> getDeniedIPs();
    ...
    CompletableFuture<DenyByIPForFailedAuthConfig> getDenyByIPForFailedAuthConfig();
    ...
    CompletableFuture<Destination> getDigitalEventsAsDestination();
    ...
    CompletableFuture<Document> getDocument(@Param("documentId") @NotNull String documentId);
    ...
    CompletableFuture<ElasticsearchDestination> getElasticsearchAsDestination();
    ...
    CompletableFuture<EmailDestination> getEmailAsDestination();
    ...
    CompletableFuture<ErrorProcessing> getErrorProcessingDetails();
    ...
    CompletableFuture<Destination> getGatewayAsDestination();
    ...
    CompletableFuture<Group> getGroup(@Param("groupId") @NotNull String groupId);
    ...
    CompletableFuture<Group> getGroups();
    ...
    CompletableFuture<IPAccessMode> getIPAccessMode(@Param("listenerKey") @NotNull String listenerKey, @NotNull IPAccessMode body);
    ...
    CompletableFuture<List<String>> getInstalledLanguages();
    ...
    CompletableFuture<ServiceRegistryPublishGetResponse> getIntegrationServerPublishInfo(@Param("apiId") @NotNull String apiId);
    ...
    CompletableFuture<JMSConnectionAlias> getJMSConnection(@Param("jmsConnId") @NotNull String jmsConnId);
    ...
    CompletableFuture<JMSTrigger> getJMSTrigger(@Param("jmsTriggerId") @NotNull String jmsTriggerId);
    ...
    CompletableFuture<JWT> getJsonWebToken(@Param("appId") @Nullable String appId);
    ...
    CompletableFuture<JWTServiceOutput> getJsonWebTokenNew(@NotNull JWTServiceInput body);
    ...
    CompletableFuture<KerberosSettings> getKerberosSetting();
    ...
    CompletableFuture<KeystoreTruststore> getKeyStoreTrustore();
    ...
    CompletableFuture<List<KeyStore>> getKeystore(@Param("keyStoreName") @NotNull String keyStoreName);
    ...
    CompletableFuture<List<KeyStore>> getKeystores();
    ...
    CompletableFuture<InputLdapConfiguration> getLdapConfig();
    ...
    CompletableFuture<LicenseDetail> getLicenseDetails();
    ...
    CompletableFuture<ListenerConfig> getListenerConfiguration();
    ...
    CompletableFuture<LoadBalancer> getLoadBalancers();
    ...
    CompletableFuture<LockedAccounts> getLockedAccounts();
    ...
    CompletableFuture<LogConfiguration> getLogConfig();
    ...
    CompletableFuture<Void> getMappings();
    ...
    CompletableFuture<MasterPasswordProperties> getMasterPasswordProperties();
    ...
    CompletableFuture<Void> getMigrationStatus(@Param("action") @NotNull String action);
    ...
    CompletableFuture<MobileApplicationConfiguration> getMobileApplicationConfigurations();
    ...
    CompletableFuture<GatewayScope> getOAuthScope(@Param("oauthScopeId") @NotNull String oauthScopeId);
    ...
    CompletableFuture<GatewayScope> getOAuthScopes();
    ...
    CompletableFuture<OutboundProxyGetResponse> getOutboundProxies();
    ...
    CompletableFuture<PackageGetResponseContainer> getPackageById(@Param("packageId") @NotNull String packageId);
    ...
    CompletableFuture<List<ModelPackage>> getPackagesForAPI(@Param("apiId") @NotNull String apiId);
    ...
    CompletableFuture<PasswordExpirySettings> getPasswordExpirySettings();
    ...
    CompletableFuture<PasswordRestrictions> getPasswordRestrictions();
    ...
    CompletableFuture<PlanGetResponse> getPlanById(@Param("planId") @NotNull String planId);
    ...
    CompletableFuture<PackagePlansResponseContainer> getPlansForPackageById(@Param("packageId") @NotNull String packageId);
    ...
    CompletableFuture<List<Policy>> getPolicies(@Param("policyIds") @Nullable String policyIds, @Param("stage") @Nullable String stage, @Param("policyType") @Nullable String policyType);
    ...
    CompletableFuture<PolicyActionWrapper> getPolicyAction(@Param("policyActionId") @NotNull String policyActionId);
    ...
    CompletableFuture<Policy> getPolicyById(@Param("policyId") @NotNull String policyId);
    ...
    CompletableFuture<List<PolicyEnforcementStage>> getPolicyStages();
    ...
    CompletableFuture<Port> getPort(@Param("listenerKey") @NotNull String listenerKey);
    ...
    CompletableFuture<Port> getPortAccessMode(@Param("listenerKey") @NotNull String listenerKey);
    ...
    CompletableFuture<Listeners> getPorts(@Param("pkg") @Nullable String pkg, @Param("listenerKey") @Nullable String listenerKey);
    ...
    CompletableFuture<MessageWithPortReference> getPrimaryPort();
    ...
    CompletableFuture<Promotion> getPromotion(@Param("promotionId") @NotNull String promotionId);
    ...
    CompletableFuture<List<Promotion>> getPromotions();
    ...
    CompletableFuture<ProxyBypass> getProxyBypass();
    ...
    CompletableFuture<Set<Object>> getPublishedPackages(@Param("portalGatewayId") @NotNull String portalGatewayId, @Param("apiId") @NotNull String apiId);
    ...
    CompletableFuture<QuiesceMode> getQuiesceMode();
    ...
    CompletableFuture<Void> getRegisteredApis(@Param("applicationId") @NotNull String applicationId);
    ...
    CompletableFuture<RemotePortConfig> getRingConfiguration();
    ...
    CompletableFuture<Rollback> getRollback(@Param("rollbackId") @NotNull String rollbackId);
    ...
    CompletableFuture<List<Rollback>> getRollbacks();
    ...
    CompletableFuture<Rule> getRule(@Param("ruleId") @NotNull String ruleId);
    ...
    CompletableFuture<SNMPDestination> getSNMPAsDestination();
    ...
    CompletableFuture<SSOConfiguration> getSSOConfiguration();
    ...
    CompletableFuture<List<ScopeResourceIndex>> getScopeByScopeName(@Param("apiId") @NotNull String apiId, @Param("scopeName") @NotNull String scopeName);
    ...
    CompletableFuture<List<ScopeResourceIndex>> getScopes(@Param("apiId") @NotNull String apiId);
    ...
    CompletableFuture<ServiceRegistryPublishGetResponse> getServiceRegistryPublishInfo(@Param("apiId") @NotNull String apiId);
    ...
    CompletableFuture<ExtendedSettingsOutput> getSettings();
    ...
    CompletableFuture<List<Multipart>> getSource(@Param("apiId") @NotNull String apiId);
    ...
    CompletableFuture<Stage> getStage(@Param("stageId") @NotNull String stageId);
    ...
    CompletableFuture<List<Stage>> getStages();
    ...
    CompletableFuture<OneOfStrategyModel> getStrategies();
    ...
    CompletableFuture<OneOfStrategyModel> getStrategy(@Param("strategyId") @NotNull String strategyId);
    ...
    CompletableFuture<Application> getSubscriptionBySubscriptionID(@Param("applicationId") @NotNull String applicationId);
    ...
    CompletableFuture<Map<String, List<TraceLog>>> getTracer(@Param("correlationID") @NotNull String correlationID);
    ...
    CompletableFuture<List<TrustStore>> getTruststore(@Param("trustStoreName") @NotNull String trustStoreName);
    ...
    CompletableFuture<List<TrustStore>> getTruststores();
    ...
    CompletableFuture<URLAliasesGetResponse> getURLALias(@Param("alias") @Nullable String alias);
    ...
    CompletableFuture<Usage> getUsageBySubscriptionID(@Param("applicationId") @NotNull String applicationId);
    ...
    CompletableFuture<User> getUser(@Param("userId") @NotNull String userId);
    ...
    CompletableFuture<User> getUsers();
    ...
    CompletableFuture<APIResponseGetAPIs> getVersions(@Param("apiId") @NotNull String apiId);
    ...
    CompletableFuture<Webhook> getWebhook(@Param("id") @NotNull String id);
    ...
    CompletableFuture<WebserviceEndpointAlias> getWebserviceEndpoint(@Param("webserviceEndpointId") @NotNull String webserviceEndpointId);
    ...
    CompletableFuture<WhiteListedIPs> getWhiteListedIPs();
    ...
    CompletableFuture<Void> importExportAPIGatewayAssets(@Param("overwrite") @Nullable String overwrite, @Param("fixingMissingVersions") @Nullable String fixingMissingVersions, @Param("preserveAssetState") @Nullable String preserveAssetState, @Param("policies") @Nullable List<String> policies, @Param("apis") @Nullable List<String> apis, @Param("aliases") @Nullable List<String> aliases, @Param("applications") @Nullable List<String> applications, @Param("approvalConfigurations") @Nullable List<String> approvalConfigurations, @Param("outboundProxies") @Nullable List<String> outboundProxies, @Param("urlAliases") @Nullable List<String> urlAliases, @Param("keyStores") @Nullable List<String> keyStores, @Param("trustStores") @Nullable List<String> trustStores, @Param("jnDIProviderAliases") @Nullable List<String> jnDIProviderAliases, @Param("jmSConnectionAliases") @Nullable List<String> jmSConnectionAliases, @Param("jmSTriggers") @Nullable List<String> jmSTriggers, @Param("webserviceEndpointAliases") @Nullable List<String> webserviceEndpointAliases, @Param("users") @Nullable List<String> users, @Param("groups") @Nullable List<String> groups, @Param("accessProfiles") @Nullable List<String> accessProfiles, @Param("kerberosSetting") @Nullable String kerberosSetting, @Param("plans") @Nullable List<String> plans, @Param("packages") @Nullable List<String> packages, @Param("configurations") @Nullable List<String> configurations, @Param("gatewayScopes") @Nullable List<String> gatewayScopes, @Param("xHTTPMethodOverride") @Nullable String xHTTPMethodOverride, @Param("zipFile") @Nullable File zipFile);
    ...
    CompletableFuture<ImportTraceInfoResponse> importTraceInfo(@Param("file") @NotNull File _file);
    ...
    CompletableFuture<Object> jWKSUri();
    ...
    CompletableFuture<Void> listAllArchives(@Param("filter") @Nullable String filter);
    ...
    CompletableFuture<Void> listAllJNDI();
    ...
    CompletableFuture<Void> listAllPendingJobs(@Param("action") @Nullable String action, @Param("status") @Nullable String status);
    ...
    CompletableFuture<JNDIProviderAlias> listJNDI(@Param("jndiId") @NotNull String jndiId);
    ...
    CompletableFuture<Void> migration(@NotNull MigrationConfig body);
    ...
    CompletableFuture<Policy> moveDownThreatProtectionRuleByPolicyID(@Param("policyId") @NotNull String policyId);
    ...
    CompletableFuture<Policy> moveUpThreatProtectionRuleByPolicyID(@Param("policyId") @NotNull String policyId);
    ...
    CompletableFuture<ModelAPIResponse> notifyAPIImplementation(@Param("apiId") @NotNull String apiId, @Param("maturityState") @Nullable String maturityState, @Param("nativeBaseURLs") @Nullable List<String> nativeBaseURLs);
    ...
    CompletableFuture<Application> patchApplication(@Param("applicationId") @NotNull String applicationId, @NotNull Application body);
    ...
    CompletableFuture<DocumentResponse> patchDocument(@Param("documentId") @NotNull String documentId, @NotNull Document body);
    ...
    CompletableFuture<Policy> policiesPost(@NotNull Policy body, @Param("action") @Nullable String action, @Param("policyIds") @Nullable String policyIds, @Param("policyScope") @Nullable String policyScope);
    ...
    CompletableFuture<List<PolicyActionTemplate>> policyActionTemplatesGet(@Param("policyActionTemplates") @Nullable String policyActionTemplates);
    ...
    CompletableFuture<PolicyActionTemplate> policyActionTemplatesPolicyActionTemplateIdGet(@Param("policyActionTemplateId") @NotNull String policyActionTemplateId);
    ...
    CompletableFuture<APIResponseCreate> publishAPI(@Param("apiId") @NotNull String apiId, @NotNull InputPublish body);
    ...
    CompletableFuture<PackageResponseContainer> publishPackageByPackageId(@Param("packageId") @NotNull String packageId);
    ...
    CompletableFuture<ServiceRegistryPublishPutResponse> publishToIntegrationServer(@NotNull InputIntegrationServerPublish body);
    ...
    CompletableFuture<ServiceRegistryPublishPutResponse> publishToServiceRegistry(@NotNull InputServiceRegistryPublish body);
    ...
    CompletableFuture<Void> purgeAPITransactions(@Param("from") @NotNull String from, @Param("until") @NotNull String until, @Param("eventType") @NotNull String eventType, @Param("action") @Nullable String action, @Param("olderThan") @Nullable String olderThan);
    ...
    CompletableFuture<QuiesceMode> quiescemode(@NotNull QuiesceMode body);
    ...
    CompletableFuture<OneOfStrategyModel> refreshCredentials(@Param("strategyId") @NotNull String strategyId, @NotNull StrategyRequest body);
    ...
    CompletableFuture<Void> regenerateAccessTokens(@Param("applicationId") @NotNull String applicationId, @NotNull AccessTokensTypeModel body);
    ...
    CompletableFuture<Void> registerApis(@Param("applicationId") @NotNull String applicationId, @NotNull List<String> body);
    ...
    CompletableFuture<MasterPasswordResetResponse> resetMasterPassword();
    ...
    CompletableFuture<Void> restoreData(@Param("fileName") @NotNull String fileName);
    ...
    CompletableFuture<CallbackProcessorSettings> saveAPICallbackProcessorSettings(@NotNull CallbackProcessorSettings body);
    ...
    CompletableFuture<Destination> saveAPIPortalAsDestination(@NotNull Destination body);
    ...
    CompletableFuture<AccountLockSettings> saveAccountLockSettings(@NotNull AccountLockSettings body);
    ...
    CompletableFuture<AnalyticsDataStoreDestination> saveAnalyticsDataStoreAsDestination(@NotNull AnalyticsDataStoreDestination body);
    ...
    CompletableFuture<AuditLogDestination> saveAuditLogAsDestination(@NotNull AuditLogDestination body);
    ...
    CompletableFuture<CSCommunicationDestination> saveCentraSiteCommunicationAsDestination(@NotNull CSCommunicationDestination body);
    ...
    CompletableFuture<CSSNMPDestination> saveCentraSiteSNMPAsDestination(@NotNull CSSNMPDestination body);
    ...
    CompletableFuture<Object> saveCustomContentTypes(@NotNull Object body);
    ...
    CompletableFuture<Destination> saveDatabaseAsDestination(@NotNull Destination body);
    ...
    CompletableFuture<DenyByIPForFailedAuthConfig> saveDenyByIPForFailedAuthConfig(@NotNull DenyByIPForFailedAuthConfig body);
    ...
    CompletableFuture<Destination> saveDigitalEventsAsDestination(@NotNull Destination body);
    ...
    CompletableFuture<ElasticsearchDestination> saveElasticsearchAsDestination(@NotNull ElasticsearchDestination body);
    ...
    CompletableFuture<EmailDestination> saveEmailAsDestination(@NotNull EmailDestination body);
    ...
    CompletableFuture<ErrorProcessing> saveErrorProcessingDetails(@NotNull ErrorProcessing body);
    ...
    CompletableFuture<Destination> saveGatewayAsDestination(@NotNull Destination body);
    ...
    CompletableFuture<KeystoreTruststore> saveKeystoreTruststore(@NotNull KeystoreTruststore body);
    ...
    CompletableFuture<InputLdapConfiguration> saveLdapConfig(@NotNull InputLdapConfiguration body);
    ...
    CompletableFuture<LoadBalancer> saveLoadBalancers(@NotNull LoadBalancer body);
    ...
    CompletableFuture<LogConfiguration> saveLogConfig();
    ...
    CompletableFuture<MobileApplicationConfiguration> saveMobileApplicationConfigurations(@NotNull MobileApplicationConfiguration body);
    ...
    CompletableFuture<PasswordExpirySettings> savePasswordExpirySettings(@NotNull PasswordExpirySettings body);
    ...
    CompletableFuture<PasswordRestrictions> savePasswordRestrictions(@NotNull PasswordRestrictions body);
    ...
    CompletableFuture<Void> saveProxyBypass(@NotNull ProxyBypass body);
    ...
    CompletableFuture<SNMPDestination> saveSNMPAsDestination(@NotNull SNMPDestination body);
    ...
    CompletableFuture<SSOConfiguration> saveSSOConfig(@NotNull SSOConfiguration body);
    ...
    CompletableFuture<ExtendedSettingsOutput> saveSettings(@NotNull ExtendedSettingsInput body);
    ...
    CompletableFuture<WhiteListedIPs> saveWhitelistedIPs(@NotNull WhiteListedIPs body);
    ...
    CompletableFuture<Map<String, Object>> searchByType(@NotNull SearchContext body);
    ...
    CompletableFuture<ServerInfo> serverInformation();
    ...
    CompletableFuture<PortReference> setPrimaryPort(@Nullable PortReference body);
    ...
    CompletableFuture<Void> shutdown(@NotNull Shutdown body);
    ...
    CompletableFuture<DocumentResponse> storeDocument(@NotNull Document body);
    ...
    CompletableFuture<Void> testJNDI(@Param("jndiId") @NotNull String jndiId);
    ...
    CompletableFuture<GatewayAPI> tracingEnable(@Param("apiId") @NotNull String apiId);
    ...
    CompletableFuture<Void> trackJobStatus(@Param("jobId") @NotNull String jobId);
    ...
    CompletableFuture<LockedAccounts> unLockUserAccounts(@NotNull UnlockAccountsRequest body);
    ...
    CompletableFuture<PackageResponseContainer> unPublishPackageByPackageId(@Param("packageId") @NotNull String packageId);
    ...
    CompletableFuture<APIResponseCreate> unpublishAPI(@Param("apiId") @NotNull String apiId);
    ...
    CompletableFuture<ServiceRegistryUnpublishPutResponse> unpublishFromServiceRegistry(@NotNull InputServiceRegistryUnpublish body);
    ...
    CompletableFuture<APIResponseCreate> updateAPI(@Param("apiId") @NotNull String apiId, @NotNull UpdateAPIRequest body, @Param("overwriteTags") @Nullable Boolean overwriteTags);
    ...
    CompletableFuture<PortalGateway> updateAPIPortalConfiguration(@Param("portalGatewayId") @NotNull String portalGatewayId, @NotNull PortalGateway body);
    ...
    CompletableFuture<AccessModeServices> updateAccessMode(@Param("listenerKey") @NotNull String listenerKey, @NotNull AccessModeServices body);
    ...
    CompletableFuture<AccessProfile> updateAccessProfile(@Param("accessProfileId") @NotNull String accessProfileId, @NotNull AccessProfile body);
    ...
    CompletableFuture<Alias> updateAlias(@Param("aliasId") @NotNull String aliasId, @NotNull Alias body);
    ...
    CompletableFuture<Void> updateApiKeysExpiry(@NotNull AccessTokensTypeModel body);
    ...
    CompletableFuture<Application> updateApplication(@Param("applicationId") @NotNull String applicationId, @NotNull Application body);
    ...
    CompletableFuture<ApprovalConfiguration> updateApprovalConfiguration(@Param("id") @NotNull String id, @NotNull ApprovalConfiguration body);
    ...
    CompletableFuture<AssertionConfiguration> updateAssertion(@Param("assertionId") @NotNull String assertionId, @NotNull AssertionConfiguration body);
    ...
    CompletableFuture<GatewayCacheConfig> updateCacheConfig();
    ...
    CompletableFuture<ClusterInfo> updateCluster(@NotNull ClusterInfo body);
    ...
    CompletableFuture<DocumentResponse> updateDocumentContent(@Param("documentId") @NotNull String documentId, @NotNull Document body);
    ...
    CompletableFuture<MasterPasswordExpiryIntervalResponse> updateExpiryInterval(@NotNull MasterPasswordExpiryInterval body);
    ...
    CompletableFuture<Group> updateGroup(@Param("groupId") @NotNull String groupId, @NotNull Group body);
    ...
    CompletableFuture<JMSConnectionAlias> updateJMSConnection(@NotNull JMSConnectionAlias body);
    ...
    CompletableFuture<JMSTrigger> updateJMSTrigger(@NotNull JMSTrigger body);
    ...
    CompletableFuture<JNDIProviderAlias> updateJNDI(@NotNull JNDIProviderAlias body);
    ...
    CompletableFuture<Void> updateKerberos(@NotNull KerberosSettings body);
    ...
    CompletableFuture<Void> updateLicenseDetails(@NotNull LicenseDetail body);
    ...
    CompletableFuture<ListenerConfig> updateListenerConfiguration(@NotNull ListenerConfig body);
    ...
    CompletableFuture<MasterPasswordUpdateResponse> updateMasterPassword(@NotNull MasterPasswordUpdate body);
    ...
    CompletableFuture<GatewayScope> updateOAuthScope(@Param("oauthScopeId") @NotNull String oauthScopeId, @NotNull GatewayScope body);
    ...
    CompletableFuture<Void> updateOutboundProxy(@NotNull OutboundProxySettings body);
    ...
    CompletableFuture<PackageResponseContainer> updatePackageByPackageId(@Param("packageId") @NotNull String packageId, @Nullable ModelPackage body);
    ...
    CompletableFuture<PlanGetResponse> updatePlanByPlanId(@Param("planId") @NotNull String planId, @Nullable Plan body);
    ...
    CompletableFuture<PolicyActionWrapper> updatePolicyAction(@Param("policyActionId") @NotNull String policyActionId, @NotNull PolicyActionWrapper body);
    ...
    CompletableFuture<Policy> updatePolicyByID(@Param("policyId") @NotNull String policyId, @Nullable Policy body);
    ...
    CompletableFuture<Port> updatePort(@Nullable Port body);
    ...
    CompletableFuture<Void> updateProxyBypass(@NotNull ProxyBypass body);
    ...
    CompletableFuture<Void> updateRegisteredApis(@Param("applicationId") @NotNull String applicationId, @NotNull List<String> body);
    ...
    CompletableFuture<RemotePortConfig> updateRingConfiguration(@NotNull RemotePortConfig body);
    ...
    CompletableFuture<Rule> updateRule(@Param("ruleId") @NotNull String ruleId, @NotNull Rule body);
    ...
    CompletableFuture<Stage> updateStage(@Param("stageId") @NotNull String stageId, @NotNull Stage body);
    ...
    CompletableFuture<OneOfStrategyModel> updateStrategy(@Param("strategyId") @NotNull String strategyId, @NotNull StrategyRequest body);
    ...
    CompletableFuture<Application> updateSubscription(@Param("applicationId") @NotNull String applicationId, @Nullable SubscriptionUpdateRequest body);
    ...
    CompletableFuture<URLAliasSettings> updateURLALias(@NotNull URLAliasSettings body);
    ...
    CompletableFuture<User> updateUser(@Param("userId") @NotNull String userId, @NotNull User body);
    ...
    CompletableFuture<Webhook> updateWebhook(@Param("id") @NotNull String id, @NotNull Webhook body);
    ...
    CompletableFuture<WebserviceEndpointAlias> updateWebserviceEndpoint(@NotNull WebserviceEndpointAlias body);
    ...
    CompletableFuture<IPAccessModeHostsList> updatedIPAccessMode(@Param("listenerKey") @NotNull String listenerKey, @NotNull IPAccessModeHostsList body);
