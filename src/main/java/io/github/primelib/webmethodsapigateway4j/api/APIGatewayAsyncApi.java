...
public interface APIGatewayAsyncApi {
    ...
    CompletableFuture<List<Usage>> getAllSubscriptionUsage(@Param("name") @Nullable String name, @Param("package") @Nullable String _package, @Param("plan") @Nullable String plan, @Param("from") @Nullable Integer from, @Param("size") @Nullable Integer size, @Param("count") @Nullable String count);
    ...
    CompletableFuture<JWT> getJsonWebToken(@Param("app_id") @Nullable String appId);
