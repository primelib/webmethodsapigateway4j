...
public class ChangeOwnerRequest {
    ...
    public enum OwnerTypeEnum {
        ...
        private static final OwnerTypeEnum[] VALUES = values(); // prevent allocating a new array for every call to values()
        private final String value;

        @JsonCreator
        public static OwnerTypeEnum of(String input) {
            if (input != null) {
                for (OwnerTypeEnum v : VALUES) {
