...
public class BodyParameter {
    ...
    /**
     * Constructs a validated implementation of {@link BodyParameter}.
     *
    ...
    protected Map<String, String> examples = new HashMap<>();
    ...
    @JsonProperty("schema")
    protected Map<String, Model> schema = new HashMap<>();
