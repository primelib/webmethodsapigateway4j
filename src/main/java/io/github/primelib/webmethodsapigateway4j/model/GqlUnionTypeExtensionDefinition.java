...
public class GqlUnionTypeExtensionDefinition {
    ...
    /**
     * Constructs a validated instance of {@link GqlUnionTypeExtensionDefinition}.
     *
     ...
     */
    @ApiStatus.Internal
    public GqlUnionTypeExtensionDefinition(List<GqlComment> comments, GqlDescription description, List<GqlDirective> directives, Map<String, GqlDirective> directivesByName, List<GqlType> memberTypes, String name) {
