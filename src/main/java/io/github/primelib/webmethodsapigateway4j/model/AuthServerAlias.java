...
public class AuthServerAlias extends Alias {
    ...
    public enum AuthServerTypeEnum {
        ...
        private static final AuthServerTypeEnum[] VALUES = values(); // prevent allocating a new array for every call to values()
        private final String value;

        @JsonCreator
        public static AuthServerTypeEnum of(String input) {
            if (input != null) {
                for (AuthServerTypeEnum v : VALUES) {
