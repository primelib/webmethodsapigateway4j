...
public class FormParameter {
    ...
    /**
     * Constructs a validated instance of {@link FormParameter}.
     *
     ...
     * Constructs a validated instance of {@link FormParameter}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #FormParameter(Consumer)} instead.
     * @param __enum __enum
     ...
     */
    @ApiStatus.Internal
    public FormParameter(List<String> __enum, Boolean allowEmptyValue, Boolean allowReserved, Map<String, MediaType> content, String _default, Boolean deprecated, String description, Map<String, Example> examples, Boolean explode, Object extendedExample, String get$ref, String in, String name, ParameterSchema parameterSchema, Boolean required, StyleEnum style, Map<String, Object> vendorExtensions, Xpath xpath) {
        this.__enum = __enum;
