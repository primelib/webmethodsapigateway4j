...
public class CreateKeystoreRequest {
    ...
    /**
     * Constructs a validated instance of {@link CreateKeystoreRequest}.
     *
     * @param spec the specification to process
     */
    public CreateKeystoreRequest(Consumer<CreateKeystoreRequest> spec) {
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link CreateKeystoreRequest}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #CreateKeystoreRequest(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public CreateKeystoreRequest(String keyStoreName, String keyStoreDescription, KeyStoreTypeEnum keyStoreType, String keyStorePassword, String uploadFileName, File fileContent, String pkAliasesList, String pkPasswordsList, String nullPKpasswds, String isPwdBase64Encoded) {
