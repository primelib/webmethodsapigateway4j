...
public class HeaderParameter {
    ...
    /**
     * Constructs a validated instance of {@link HeaderParameter}.
     *
     * @param spec the specification to process
     */
    public HeaderParameter(Consumer<HeaderParameter> spec) {
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link HeaderParameter}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #HeaderParameter(Consumer)} instead.
     * @param __enum __enum
     ...
     */
    @ApiStatus.Internal
    public HeaderParameter(List<String> __enum, Boolean allowEmptyValue, Boolean allowReserved, Map<String, MediaType> content, String _default, Boolean deprecated, String description, Map<String, Example> examples, Boolean explode, Object extendedExample, String get$ref, String in, String name, ParameterSchema parameterSchema, Boolean required, StyleEnum style, Map<String, Object> vendorExtensions, Xpath xpath) {
        this.__enum = __enum;
