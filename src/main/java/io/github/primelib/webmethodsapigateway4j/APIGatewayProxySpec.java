...
@Slf4j
public class APIGatewayProxySpec {
    /*
    ...
    /**
     * Constructs a validated implementation of {@link APIGatewayProxySpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public APIGatewayProxySpec(Consumer<APIGatewayProxySpec> spec) {
        spec.accept(this);
        validate();
    }
    ...
    /**
     * Creates a new {@link APIGatewayProxySpec} with values taken from the proxy environment variables, if applicable.
     */
    public static APIGatewayProxySpec detect() {
        ...
        for (String p : proxies) {
            try {
                ...
                return new APIGatewayProxySpec(spec -> {
