...
@JsonTypeName("MonetizationComponents")
@JsonPropertyOrder({
    "callbacks",
    "examples",
    "headers",
...
public class MonetizationComponents {
    ...
    /**
     * Constructs a validated instance of {@link MonetizationComponents}.
     *
     * @param spec the specification to process
     */
    public MonetizationComponents(Consumer<MonetizationComponents> spec) {
        super();
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link MonetizationComponents}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #MonetizationComponents(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public MonetizationComponents(Map<String, ServiceMgmtCallback> callbacks, Map<String, ServiceMgmtExample> examples, Map<String, Object> headers, Map<String, ServiceMgmtLink> links, Map<String, String> parameters, Map<String, ServiceMgmtRequestBody> requestBodies, Map<String, Object> responses, Map<String, ServiceMgmtSchema> schemas, Map<String, ServiceMgmtSecurityScheme> securitySchemes, Map<String, Object> vendorExtensions) {
