...
@JsonTypeName("AdminAuditLogDestination")
@JsonPropertyOrder({
    "destination",
    "enable",
    "guaranteed",
...
public class AdminAuditLogDestination {
    ...
    /**
     * Constructs a validated instance of {@link AdminAuditLogDestination}.
     *
     ...
     * Constructs a validated instance of {@link AdminAuditLogDestination}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #AdminAuditLogDestination(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public AdminAuditLogDestination(String destination, String enable, String guaranteed, String maximumQueueSize, String maximumRetries, String mode, String name, String waitBetweenRetries) {
