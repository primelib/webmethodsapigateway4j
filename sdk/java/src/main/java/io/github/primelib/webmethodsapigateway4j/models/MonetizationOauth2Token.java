...
@JsonTypeName("MonetizationOauth2Token")
@JsonPropertyOrder({
    "clientId",
    "clientName",
    "clientSecret",
...
public class MonetizationOauth2Token {
    ...
    /**
     * Constructs a validated instance of {@link MonetizationOauth2Token}.
     *
     * @param spec the specification to process
     */
    public MonetizationOauth2Token(Consumer<MonetizationOauth2Token> spec) {
        super();
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link MonetizationOauth2Token}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #MonetizationOauth2Token(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public MonetizationOauth2Token(String clientId, String clientName, String clientSecret, String expirationInterval, List<String> redirectUris, String refreshCount, List<String> scopes, String type) {
