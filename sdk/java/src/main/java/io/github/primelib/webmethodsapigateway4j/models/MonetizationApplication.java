...
@JsonTypeName("MonetizationApplication")
@JsonPropertyOrder({
    "accessTokens",
    "applicationId",
    "authStrategyIds",
...
public class MonetizationApplication {
    ...
    protected MonetizationApplicationToken accessTokens;
    ...
    protected List<MonetizationApplicationIDEntifier> identifiers;
    ...
    protected MonetizationNode primaryNode;
    ...
    /**
     * Constructs a validated instance of {@link MonetizationApplication}.
     *
     * @param spec the specification to process
     */
    public MonetizationApplication(Consumer<MonetizationApplication> spec) {
        super();
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link MonetizationApplication}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #MonetizationApplication(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public MonetizationApplication(MonetizationApplicationToken accessTokens, String applicationId, List<String> authStrategyIds, List<String> contactEmails, String creationDate, Map<String, String> customFields, String description, String iconbyteArray, List<MonetizationApplicationIDEntifier> identifiers, Boolean isSuspended, List<String> jsOrigins, String lastModified, Long lastUpdated, String name, String owner, String ownerType, MonetizationNode primaryNode, Boolean shell, List<String> siteUrls, Boolean subscription, String version) {
