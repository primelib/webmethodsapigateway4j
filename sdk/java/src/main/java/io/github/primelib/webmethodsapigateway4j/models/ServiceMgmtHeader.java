...
@JsonTypeName("ServiceMgmtHeader")
@JsonPropertyOrder({
    "Enum",
    "allowEmptyValue",
    "allowReserved",
...
public class ServiceMgmtHeader {
    ...
    /**
     * Constructs a validated instance of {@link ServiceMgmtHeader}.
     *
     * @param spec the specification to process
     */
    public ServiceMgmtHeader(Consumer<ServiceMgmtHeader> spec) {
        super();
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link ServiceMgmtHeader}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #ServiceMgmtHeader(Consumer)} instead.
     * @param Enum Enum
     ...
     */
    @ApiStatus.Internal
    public ServiceMgmtHeader(List<String> Enum, Boolean allowEmptyValue, Boolean allowReserved, Map<String, ServiceMgmtMediaType> content, String defaultProp, Boolean deprecated, String description, Map<String, ServiceMgmtExample> examples, Boolean explode, Object extendedExample, String getref, String in, String name, ServiceMgmtSchema parameterSchema, Boolean required, String style, Map<String, Object> vendorExtensions, ServiceMgmtXpath xpath) {
        this.Enum = Enum;
