...
public class AdminClusterInfo {
    ...
    /**
     * Constructs a validated instance of {@link AdminClusterInfo}.
     *
     * @param spec the specification to process
     */
    public AdminClusterInfo(Consumer<AdminClusterInfo> spec) {
        super();
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link AdminClusterInfo}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #AdminClusterInfo(Consumer)} instead.
     * @param ignite Used to hold the information about the Ignite settings of an API Gateway cluster
     ...
     */
    @ApiStatus.Internal
    public AdminClusterInfo(AdminIgnite ignite, String actionOnStartupError, String cacheManagerName, String cacheName, Boolean clusterAware, String clusterName, String clusterSessTimeout, Boolean currentlyClustered, String message, Boolean pendingRestart, String tsaUrls) {
        this.ignite = ignite;
