...
@JsonTypeName("ArchiveSearchRange")
@JsonPropertyOrder({
    "from",
    "since",
    "to"
...
public class ArchiveSearchRange {
    ...
    /**
     * Constructs a validated instance of {@link ArchiveSearchRange}.
     *
     * @param spec the specification to process
     */
    public ArchiveSearchRange(Consumer<ArchiveSearchRange> spec) {
        super();
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link ArchiveSearchRange}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #ArchiveSearchRange(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public ArchiveSearchRange(Object from, String since, Object to) {
        this.from = from;
        this.since = since;
        this.to = to;
    }
