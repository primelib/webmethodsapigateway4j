...
public class AdminShutdown {
    ...
    /**
     * Constructs a validated instance of {@link AdminShutdown}.
     *
     ...
     * Constructs a validated instance of {@link AdminShutdown}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #AdminShutdown(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public AdminShutdown(Boolean bounce, String option, Boolean quiesce, Integer timeout) {
        this.bounce = bounce;
        this.option = option;
