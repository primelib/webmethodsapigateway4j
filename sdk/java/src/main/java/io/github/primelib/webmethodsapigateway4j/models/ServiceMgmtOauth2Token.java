...
@JsonTypeName("ServiceMgmtOauth2Token")
@JsonPropertyOrder({
    "clientId",
    "clientName",
    "clientSecret",
...
public class ServiceMgmtOauth2Token {
    ...
    /**
     * Constructs a validated instance of {@link ServiceMgmtOauth2Token}.
     *
     * @param spec the specification to process
     */
    public ServiceMgmtOauth2Token(Consumer<ServiceMgmtOauth2Token> spec) {
        super();
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link ServiceMgmtOauth2Token}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #ServiceMgmtOauth2Token(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public ServiceMgmtOauth2Token(String clientId, String clientName, String clientSecret, String expirationInterval, List<String> redirectUris, String refreshCount, List<String> scopes, String type) {
