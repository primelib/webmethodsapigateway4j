...
@JsonTypeName("AliasRemoteIsconfig")
@JsonPropertyOrder({
    "acl",
    "host",
    "keepAlive",
...
public class AliasRemoteIsconfig {
    ...
    /**
     * Constructs a validated instance of {@link AliasRemoteIsconfig}.
     *
     * @param spec the specification to process
     */
    public AliasRemoteIsconfig(Consumer<AliasRemoteIsconfig> spec) {
        super();
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link AliasRemoteIsconfig}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #AliasRemoteIsconfig(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public AliasRemoteIsconfig(String acl, String host, Integer keepAlive, String password, Integer port, Integer timeout, Boolean useSsl, String username) {
        this.acl = acl;
        this.host = host;
