...
@JsonTypeName("ApplicationApplication")
@JsonPropertyOrder({
    "accessTokens",
    "applicationId",
    "authStrategyIds",
...
public class ApplicationApplication {
    ...
    protected ApplicationApplicationToken accessTokens;
    ...
    protected List<ApplicationApplicationIDEntifier> identifiers;
    ...
    /**
     * Constructs a validated instance of {@link ApplicationApplication}.
     *
     * @param spec the specification to process
     */
    public ApplicationApplication(Consumer<ApplicationApplication> spec) {
        super();
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link ApplicationApplication}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #ApplicationApplication(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public ApplicationApplication(ApplicationApplicationToken accessTokens, String applicationId, List<String> authStrategyIds, List<String> contactEmails, String creationDate, Map<String, String> customFields, String description, String iconbyteArray, List<ApplicationApplicationIDEntifier> identifiers, Boolean isSuspended, List<String> jsOrigins, String lastModified, Long lastUpdated, String name, String owner, String ownerType, ApplicationNode primaryNode, Boolean shell, List<String> siteUrls, Boolean subscription, String version) {
