...
@JsonTypeName("MonetizationPackage")
@JsonPropertyOrder({
    "active",
    "apiIds",
    "creationDate",
...
public class MonetizationPackage {
    ...
    /**
     * Constructs a validated instance of {@link MonetizationPackage}.
     *
     * @param spec the specification to process
     */
    public MonetizationPackage(Consumer<MonetizationPackage> spec) {
        super();
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link MonetizationPackage}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #MonetizationPackage(Consumer)} instead.
     * @param active active
     ...
     */
    @ApiStatus.Internal
    public MonetizationPackage(Boolean active, List<String> apiIds, Long creationDate, Map<String, String> customFields, String description, String icon, String id, Long modifiedDate, String name, List<String> planIds, List<String> policyIds, List<String> publishedPortals, List<String> tags, String version) {
        this.active = active;
        this.apiIds = apiIds;
