...
@JsonTypeName("ServiceMgmtParameter")
@JsonPropertyOrder({
    "Enum",
    "allowEmptyValue",
    "allowReserved",
...
public class ServiceMgmtParameter {
    ...
    protected ServiceMgmtSchema parameterSchema;
    ...
    @JsonProperty("xpath")
    protected ServiceMgmtXpath xpath;

    /**
     * Constructs a validated instance of {@link ServiceMgmtParameter}.
     *
     * @param spec the specification to process
     */
    public ServiceMgmtParameter(Consumer<ServiceMgmtParameter> spec) {
        super();
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link ServiceMgmtParameter}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #ServiceMgmtParameter(Consumer)} instead.
     * @param Enum Enum
     ...
     */
    @ApiStatus.Internal
    public ServiceMgmtParameter(List<String> Enum, Boolean allowEmptyValue, Boolean allowReserved, Map<String, ServiceMgmtMediaType> content, String defaultProp, Boolean deprecated, String description, Map<String, ServiceMgmtExample> examples, Boolean explode, Object extendedExample, String getref, String in, String name, ServiceMgmtSchema parameterSchema, Boolean required, String style, Map<String, Object> vendorExtensions, ServiceMgmtXpath xpath) {
        this.Enum = Enum;
