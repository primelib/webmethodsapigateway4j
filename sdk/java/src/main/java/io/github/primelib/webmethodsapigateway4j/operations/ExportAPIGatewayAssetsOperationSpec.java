...
public class ExportAPIGatewayAssetsOperationSpec {
    ...
    /**
     * This parameter indicates whether you want to export the applications associated with the
     * APIs
     *
     */
    @Nullable
    ...
    /**
     * This parameter identifies the outbound proxy aliases to be exported. outbound proxy aliases are identified with it's name.
    ...
    /**
     * This parameter identifies the URL aliases to be exported. URL aliases are identified with it's name.
    ...
    /**
     * This parameter identifies the keystore aliases to be exported. Keystore aliases are identified with it's name.
    ...
    /**
     * This parameter identifies the truststore aliases to be exported. Truststore aliases are identified with it's name.
    ...
    /**
     * This parameter identifies the JNDI provider aliases to be exported. JNDI provider aliases are identified with it's name.
    ...
    /**
     * This parameter identifies the JMS connection aliases to be exported. JMS connection aliases are identified with it's name.
     * The wildcard "*" selects all the JNDI provider aliases. 
     * For example, a single JNDI provider alias can be exported using the following request:
    ...
    /**
     * This parameter identifies the JMS triggers to be exported. JMS triggers are identified with it's name.
    ...
    /**
     * This parameter identifies the 'web service endpoint' aliases to be exported. Web service endpoint aliases are identified with it's name.
    ...
    /**
     * This parameter identifies the kerberos configuration to be exported.
