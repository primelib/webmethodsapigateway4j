...
@JsonTypeName("ServiceMgmtResponse")
@JsonPropertyOrder({
    "content",
    "description",
    "getref",
...
public class ServiceMgmtResponse {
    ...
    /**
     * Constructs a validated instance of {@link ServiceMgmtResponse}.
     *
     ...
     * Constructs a validated instance of {@link ServiceMgmtResponse}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #ServiceMgmtResponse(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public ServiceMgmtResponse(Map<String, ServiceMgmtMediaType> content, String description, String getref, Map<String, ServiceMgmtHeader> headersV3, Map<String, ServiceMgmtLink> links, Map<String, Object> vendorExtensions) {
