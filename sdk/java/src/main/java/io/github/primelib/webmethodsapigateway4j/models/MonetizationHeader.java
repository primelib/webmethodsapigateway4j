...
@JsonTypeName("MonetizationHeader")
@JsonPropertyOrder({
    "Enum",
    "allowEmptyValue",
    "allowReserved",
...
public class MonetizationHeader {
    ...
    /**
     * Constructs a validated instance of {@link MonetizationHeader}.
     *
     * @param spec the specification to process
     */
    public MonetizationHeader(Consumer<MonetizationHeader> spec) {
        super();
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link MonetizationHeader}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #MonetizationHeader(Consumer)} instead.
     * @param Enum Enum
     ...
     */
    @ApiStatus.Internal
    public MonetizationHeader(List<String> Enum, Boolean allowEmptyValue, Boolean allowReserved, Map<String, ServiceMgmtMediaType> content, String defaultProp, Boolean deprecated, String description, Map<String, ServiceMgmtExample> examples, Boolean explode, Object extendedExample, String getref, String in, String name, MonetizationSchema parameterSchema, Boolean required, String style, Map<String, Object> vendorExtensions, MonetizationXpath xpath) {
        this.Enum = Enum;
