...
@JsonTypeName("ServiceMgmtSchema")
@JsonPropertyOrder({
...
public class ServiceMgmtSchema {

    @JsonProperty("additionalProperties")
    protected ServiceMgmtSchema additionalProperties;
    ...
    @JsonProperty("not")
    protected ServiceMgmtSchema not;
...
The required keyword takes an array of zero or more strings. Each of these strings must be unique.
    ...
    /**
     * Constructs a validated instance of {@link ServiceMgmtSchema}.
     *
     * @param spec the specification to process
     */
    public ServiceMgmtSchema(Consumer<ServiceMgmtSchema> spec) {
        super();
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link ServiceMgmtSchema}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #ServiceMgmtSchema(Consumer)} instead.
...
The required keyword takes an array of zero or more strings. Each of these strings must be unique.
     ...
     */
    @ApiStatus.Internal
    public ServiceMgmtSchema(ServiceMgmtSchema additionalProperties, Boolean additionalPropertiesAsBoolean, Object defaultProp, Boolean deprecated, String description, List<Object> enumProp, Object example, Boolean exclusiveMaximum, Boolean exclusiveMinimum, ServiceMgmtExternalDocs externalDocs, String format, String getref, Integer maxItems, Integer maxLength, Integer maxProperties, Double maximum, Integer minItems, Integer minLength, Integer minProperties, Double minimum, Double multipleOf, String name, ServiceMgmtSchema not, Boolean nullable, String pattern, Map<String, ServiceMgmtSchema> properties, Boolean readOnly, List<String> required, String title, String type, Boolean uniqueItems, Map<String, Object> vendorExtensions, Boolean writeOnly, ServiceMgmtXml xml) {
