...
@JsonTypeName("ServiceMgmtServer")
@JsonPropertyOrder({
    "description",
    "url",
    "variables",
...
public class ServiceMgmtServer {
    ...
    /**
     * Constructs a validated instance of {@link ServiceMgmtServer}.
     *
     ...
     * Constructs a validated instance of {@link ServiceMgmtServer}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #ServiceMgmtServer(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public ServiceMgmtServer(String description, String url, Map<String, ServiceMgmtServerVariable> variables, Map<String, Object> vendorExtensions) {
