...
/**
 * AdminJmsconnectionAlias
 * <p>
 * This model contains JMS connection alias details
 *
 */
@Getter
@Setter
...
@JsonTypeName("AdminJmsconnectionAlias")
@JsonPropertyOrder({
    "aliasName",
    ...
    "jndiAutomaticallyCreateUmadminObjects",
    "jndiConnectionFactoryLookupName",
    "jndiConnectionFactoryPollingInterval",
    "jndiConnectionFactoryUpdateType",
    "jndiEnableFollowTheMaster",
    "jndiJndiAliasName",
    "manageDestinations",
    "optTempQueueCreate",
    "password",
    ...
    "transactionType",
    "umLoggingOutput",
    "umProducerIncludedStrings",
    "umProducerMessageTracking",
    "user"
})
@Generated(value = "io.github.primelib.primecodegen")
public class AdminJmsconnectionAlias {
    ...
    /**
     * Constructs a validated instance of {@link AdminJmsconnectionAlias}.
     *
     * @param spec the specification to process
     */
    public AdminJmsconnectionAlias(Consumer<AdminJmsconnectionAlias> spec) {
        super();
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link AdminJmsconnectionAlias}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #AdminJmsconnectionAlias(Consumer)} instead.
