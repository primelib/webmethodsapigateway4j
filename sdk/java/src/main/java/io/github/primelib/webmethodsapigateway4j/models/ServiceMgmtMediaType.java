...
@JsonTypeName("ServiceMgmtMediaType")
@JsonPropertyOrder({
    "example",
    "examples",
    "schema",
...
public class ServiceMgmtMediaType {
    ...
    @JsonProperty("schema")
    protected ServiceMgmtSchema schema;

    @JsonProperty("vendorExtensions")
    protected Map<String, Object> vendorExtensions;

    /**
     * Constructs a validated instance of {@link ServiceMgmtMediaType}.
     *
     * @param spec the specification to process
     */
    public ServiceMgmtMediaType(Consumer<ServiceMgmtMediaType> spec) {
        super();
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link ServiceMgmtMediaType}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #ServiceMgmtMediaType(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public ServiceMgmtMediaType(Object example, Map<String, ServiceMgmtExample> examples, ServiceMgmtSchema schema, Map<String, Object> vendorExtensions) {
