...
@JsonTypeName("ServiceMgmtEntityType")
@JsonPropertyOrder({
    "getmIds",
    "methods",
...
public class ServiceMgmtEntityType {
    ...
    /**
     * Constructs a validated instance of {@link ServiceMgmtEntityType}.
     *
     * @param spec the specification to process
     */
    public ServiceMgmtEntityType(Consumer<ServiceMgmtEntityType> spec) {
        super();
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link ServiceMgmtEntityType}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #ServiceMgmtEntityType(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public ServiceMgmtEntityType(List<String> getmIds, Map<String, ServiceMgmtMethodParameters> methods, Map<String, ServiceMgmtEntitySet> navigationProperties, Map<String, ServiceMgmtSchema> properties, List<String> props) {
