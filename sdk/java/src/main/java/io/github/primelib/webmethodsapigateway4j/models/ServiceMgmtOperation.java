...
@JsonTypeName("ServiceMgmtOperation")
@JsonPropertyOrder({
    "callbacks",
    "deprecated",
    "description",
...
public class ServiceMgmtOperation {
    ...
    protected List<ServiceMgmtParameter> parameters;

    @JsonProperty("requestBody")
    protected ServiceMgmtRequestBody requestBody;
    ...
    /**
     * Constructs a validated instance of {@link ServiceMgmtOperation}.
     *
     * @param spec the specification to process
     */
    public ServiceMgmtOperation(Consumer<ServiceMgmtOperation> spec) {
        super();
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link ServiceMgmtOperation}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #ServiceMgmtOperation(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public ServiceMgmtOperation(Map<String, ServiceMgmtCallback> callbacks, Boolean deprecated, String description, Boolean enabled, ServiceMgmtExternalDocs externalDocs, List<ServiceMgmtMockedConditionsBasedCustomResponse> mockedConditionsBasedCustomResponsesList, Map<String, ServiceMgmtMockedResponse> mockedResponses, String operationId, List<ServiceMgmtParameter> parameters, ServiceMgmtRequestBody requestBody, Map<String, Object> responses, List<String> scopes, String summary, List<String> tags, Map<String, Object> vendorExtensions) {
