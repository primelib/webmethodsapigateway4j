 ...
 * SearchSearchContext
 * <p>
 * This defines the request structure to search across API Gateway
 *
 */
@Getter
@Setter
...
@JsonTypeName("SearchSearchContext")
@JsonPropertyOrder({
    "aggregations",
    "condition",
    "deploymentFilter",
...
public class SearchSearchContext {

    @JsonProperty("aggregations")
    protected List<SearchIaggregation> aggregations;
    ...
    @JsonProperty("scope")
    protected List<SearchSearchField> scope;
    ...
    /**
     * Constructs a validated instance of {@link SearchSearchContext}.
     *
     * @param spec the specification to process
     */
    public SearchSearchContext(Consumer<SearchSearchContext> spec) {
        super();
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link SearchSearchContext}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #SearchSearchContext(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public SearchSearchContext(List<SearchIaggregation> aggregations, String condition, String deploymentFilter, Integer from, List<String> responseFields, List<SearchSearchField> scope, Integer size, String sortByField, String sortOrder, List<String> teamFilter, List<String> types) {
