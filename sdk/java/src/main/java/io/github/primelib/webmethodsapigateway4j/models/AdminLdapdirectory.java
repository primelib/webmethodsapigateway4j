...
@JsonTypeName("AdminLdapdirectory")
@JsonPropertyOrder({
...
public class AdminLdapdirectory {
    ...
    /**
     * The user ID the Integration Server should supply to connect to the LDAP server, for example, o=webm.com or dc=webm,dc=com.  This user should not be the Administrator account, but a user that has permission to query groups and group membership. If your LDAP server allows anonymous access, leave this field blank.
     */
    ...
    /**
     * Constructs a validated instance of {@link AdminLdapdirectory}.
     *
     * @param spec the specification to process
     */
    public AdminLdapdirectory(Consumer<AdminLdapdirectory> spec) {
        super();
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link AdminLdapdirectory}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #AdminLdapdirectory(Consumer)} instead.
