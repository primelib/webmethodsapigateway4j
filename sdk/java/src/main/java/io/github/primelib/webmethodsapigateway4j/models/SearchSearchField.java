...
@JsonTypeName("SearchSearchField")
@JsonPropertyOrder({
    "attributeName",
    "keyword",
    "orTokenKey",
...
public class SearchSearchField {
 ...
 2. Search the transactional events where the request data size in between 1000 and 4000 - {"attributeName" : "apiName", "range" : {"from" : 1000, "to" : 4000}}.
     */
    @JsonProperty("range")
    protected SearchSearchRange range;

    @JsonProperty("rawFieldKey")
    protected String rawFieldKey;

    /**
     * Constructs a validated instance of {@link SearchSearchField}.
     *
     * @param spec the specification to process
     */
    public SearchSearchField(Consumer<SearchSearchField> spec) {
        super();
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link SearchSearchField}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #SearchSearchField(Consumer)} instead.
 ...
 2. Search the transactional events where the request data size in between 1000 and 4000 - {"attributeName" : "apiName", "range" : {"from" : 1000, "to" : 4000}}.
     ...
     */
    @ApiStatus.Internal
    public SearchSearchField(String attributeName, String keyword, Boolean orTokenKey, SearchSearchRange range, String rawFieldKey) {
