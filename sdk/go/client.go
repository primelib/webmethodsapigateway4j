...
// New returns a new WebMethodsAPIGatewayClient API client.
func New(options ...OptionFunc) (Client, error) {
	...
	// user-agent
	restyClient.SetHeader("User-Agent", "PrimeCodeGen-WebMethodsAPIGatewayClient/1.0.0")
	...
	if restyClient.BaseURL == "" {
		err := WithBaseURL("http://localhost:5555/rest/apigateway")(&client)
		if err != nil {
			return client, errors.Join(ErrFailedToCreateClient, err)
		}
	}
