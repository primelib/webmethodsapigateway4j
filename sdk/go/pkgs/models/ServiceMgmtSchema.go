...
type ServiceMgmtSchema struct {
	AdditionalProperties          *ServiceMgmtSchema       `json:"additionalProperties" form:"name=additionalProperties,json"`
	...
	Not                           *ServiceMgmtSchema       `json:"not" form:"name=not,json"`
