...
// SearchSearchContext This defines the request structure to search across API Gateway

type SearchSearchContext struct {
	Aggregations     []*SearchIaggregation `json:"aggregations" form:"name=aggregations,json"`
	...
	Scope            []*SearchSearchField  `json:"scope" form:"name=scope,json"`
