...
type ServiceMgmtParameter struct {
	...
	ParameterSchema  *ServiceMgmtSchema `json:"parameterSchema" form:"name=parameterSchema,json"`
	...
	Xpath            *ServiceMgmtXpath  `json:"xpath" form:"name=xpath,json"`
}
