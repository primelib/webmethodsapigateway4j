...
type ServiceMgmtGqlInterfaceTypeExtensionDefinition struct {
	...
	FieldDefinitions []*ServiceMgmtGqlFieldDefinition `json:"fieldDefinitions" form:"name=fieldDefinitions,json"` // List of field definitions
	Implements       []*ServiceMgmtGqlType            `json:"implements" form:"name=implements,json"`
