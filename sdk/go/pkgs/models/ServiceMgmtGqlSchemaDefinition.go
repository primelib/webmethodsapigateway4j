...
type ServiceMgmtGqlSchemaDefinition struct {
	...
	OperationTypeDefinitions []*ServiceMgmtGqlOperationTypeDefinition `json:"operationTypeDefinitions" form:"name=operationTypeDefinitions,json"` // List of operation type definitions
}
