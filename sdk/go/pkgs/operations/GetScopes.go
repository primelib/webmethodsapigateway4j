...
func GetScopes(client *resty.Client, ctx context.Context, req GetScopesRequest) (*GetScopesResponse, error) {
	...
	// send the request
	resp, err := r.Get("/apis/{apiId}/scopes")
	if err != nil {
		return nil, err
	}
